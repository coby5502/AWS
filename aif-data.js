...
window.AIF_QUESTIONS = [
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Explainability — 모델이 왜 그런 예측을 했는지 비전문가도 이해할 수 있게 설명하는 능력.\n▸ PDP (Partial Dependence Plot) — 특정 입력 피처 값이 바뀔 때 예측이 어떻게 변하는지 시각화. 이해관계자에게 '이 변수가 예측에 이렇게 영향을 준다'를 그래프로 보여주기에 최적.\n\n【정답 포인트】\n▸ 투명성·설명 가능성 = 시각적 자료로 입력→출력 관계를 보여주는 PDP가 표준 답.\n\n【오답 체크】\n(A) 학습 코드는 개발자용 — 비기술 이해관계자에게 부적합.\n(C) 샘플 데이터는 품질 검증용이지 설명 도구가 아님.\n(D) 수렴 테이블은 학습 과정 모니터링용.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Summarization (요약) — 긴 문서에서 핵심을 추출해 짧게 만드는 생성형 AI의 대표 활용 사례.\n▸ LLM (Large Language Model) — 대규모 텍스트로 사전 학습된 언어 모델. Bedrock의 Claude·Titan 등.\n\n【정답 포인트】\n▸ \"문서를 읽고 핵심 내용을 추출\" = 문서 요약 태스크 → 요약 챗봇이 정확한 매치.\n\n【오답 체크】\n(A) NER은 고유명사·엔티티만 뽑는 것 — 핵심 내용 요약과는 다름.\n(B) 추천은 사용자-아이템 매칭.\n(D) 번역은 언어 간 변환.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Decision Tree — 규칙 기반 분기 구조. 각 노드가 '어떤 피처가 어떤 값일 때 어디로 분기'를 보여주므로 의사결정 경로가 투명하게 드러남. 대표적인 설명 가능한(interpretable) 모델.\n\n【정답 포인트】\n▸ \"분류 + 내부 동작 문서화\" = 트리 구조 그 자체가 설명이 되는 Decision Tree가 최적.\n\n【오답 체크】\n(B) Linear Regression은 연속값 예측용, 분류 X.\n(C) Logistic Regression은 이진 분류 중심. 다중 클래스(20)엔 트리가 유리.\n(D) Neural Networks는 블랙박스 — 설명 가능성이 낮음.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Accuracy (정확도) — 전체 샘플 중 맞게 분류한 비율 = TP+TN / 전체. 분류 모델 평가의 기본 지표.\n▸ RMSE — 회귀 모델에서 예측값과 실제값의 오차를 측정.\n\n【정답 포인트】\n▸ \"얼마나 많이 올바르게 분류했는가\" = Accuracy의 정의 그 자체.\n\n【오답 체크】\n(A) R² score는 회귀 모델용.\n(C) RMSE도 회귀 모델용, 연속값 오차 측정.\n(D) Learning rate는 학습 하이퍼파라미터, 평가 지표가 아님.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Prompt Engineering — 프롬프트 문장을 조정해 원하는 형태·길이·언어의 응답을 유도하는 기법. 가장 빠르고 비용 없는 방법.\n▸ Temperature — 높을수록 랜덤·창의적, 낮을수록 결정적. 길이·언어 제어와 무관.\n\n【정답 포인트】\n▸ \"짧게, 특정 언어로\" 같은 형식 요구는 프롬프트에 \"3문장 이내, 한국어로\" 등을 명시하면 해결.\n\n【오답 체크】\n(B) 모델 교체는 과도한 조치.\n(C) Temperature는 창의성 조절, 언어·길이 제어엔 부적합.\n(D) Top K도 다양성 제어, 요구사항과 무관.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ SageMaker Asynchronous Inference — 대용량 페이로드(최대 1GB)와 긴 처리 시간(최대 1시간)을 지원하는 추론 옵션. 요청은 큐에 넣고 결과를 S3로 반환. near real-time이지만 즉시 응답은 아님.\n▸ Real-time Inference — 저지연(수백 ms) 요구에 맞지만 페이로드 6MB·60초 제한.\n▸ Batch Transform — 대용량 일괄 처리, 지연 요건 없을 때.\n\n【정답 포인트】\n▸ 1GB·1시간·near real-time 3가지 키워드 = Asynchronous Inference의 정확한 유스케이스.\n\n【오답 체크】\n(A) 6MB·60초 초과 → 불가.\n(B) Serverless는 제한 더 엄격.\n(D) Batch는 실시간성 없음.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ SageMaker Ground Truth Plus — AWS 관리형 라벨링 서비스. 전문 라벨러 팀이 데이터를 검수·라벨링하며 Human-in-the-loop(HITL) 구조로 정확도를 보장.\n▸ Human-in-the-loop — ML 판단에 사람이 개입해 정확도를 높이는 패턴.\n\n【정답 포인트】\n▸ \"높은 정확도 + 잘못된 annotation 최소화\" = 사람이 검수하는 Ground Truth Plus가 최적.\n\n【오답 체크】\n(B) Bedrock 지식 베이스는 텍스트 RAG용, 이미지 라벨링 아님.\n(C) Rekognition은 이미 학습된 객체 인식, 커스텀 라벨링 작업과 다름.\n(D) QuickSight Q는 BI 대시보드 자연어 질의.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ IAM Role — AWS 서비스가 다른 서비스에 접근할 때 assume 하는 권한 묶음.\n▸ SSE-S3 — S3 관리형 키로 객체를 암호화. 접근 시 암묵적으로 복호화되지만, role에 kms:Decrypt / s3:GetObject 권한이 필요.\n\n【정답 포인트】\n▸ 접근 실패 = 권한 문제. Bedrock의 실행 role에 S3 읽기 + 복호화 권한을 부여.\n\n【오답 체크】\n(B) Public 접근은 심각한 보안 위험 — 절대 금지.\n(C) 프롬프트로 권한 문제를 해결할 수 없음.\n(D) 요구사항과 무관.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon Q Developer — AWS의 개발자용 AI 어시스턴트. IDE·CLI 통합. 코드 제안·리팩토링·보안 스캔·오픈소스 라이선스 추적·레퍼런스 추적 등 개발 생산성 기능 제공.\n\n【정답 포인트】\n▸ Q Developer의 대표 기능 묶음 = A.\n\n【오답 체크】\n(B) 서버리스 실행은 Lambda의 영역.\n(C) 음성 명령은 일반적 기능이 아님.\n(D) 오디오→텍스트는 Amazon Transcribe.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS PrivateLink — VPC에서 AWS 서비스로 가는 트래픽이 인터넷을 통하지 않고 AWS 백본만으로 흐르게 하는 프라이빗 엔드포인트. Bedrock·S3 등 대부분 서비스 지원.\n\n【정답 포인트】\n▸ \"VPC + 인터넷 금지\" = PrivateLink(또는 VPC Endpoint)로 해결.\n\n【오답 체크】\n(B) Macie는 S3 민감 데이터 탐지.\n(C) CloudFront는 퍼블릭 CDN.\n(D) Internet Gateway는 반대로 인터넷을 여는 장치.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ 런타임 효율 = 운영 중인 모델의 응답 성능. 대표 지표가 평균 응답 시간(inference latency).\n\n【정답 포인트】\n▸ 운영·인퍼런스 단계의 효율 = 응답 시간.\n\n【오답 체크】\n(A) CSAT는 사용자 만족도.\n(B) 에폭당 학습 시간은 학습 단계 지표.\n(D) 인스턴스 수는 비용·규모 지표.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon Transcribe — 음성을 텍스트로 자동 전사(speech-to-text). 통화·회의 녹음 분석의 첫 단계.\n▸ Amazon Comprehend — 텍스트에서 엔티티·감정·주제 추출. Transcribe 뒤에 붙여 쓰는 조합이 일반적.\n\n【정답 포인트】\n▸ \"오디오를 분석\" = 먼저 텍스트로 전사해야 함 → Transcribe.\n\n【오답 체크】\n(A) Lex는 챗봇 대화 엔진.\n(C) Model Monitor는 배포된 모델 품질 모니터링.\n(D) Comprehend는 텍스트 입력 기준 — 오디오엔 직접 불가.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Bedrock Fine-tuning — 기본 FM에 '프롬프트-완성(prompt-completion)' 쌍이 담긴 JSONL 파일을 제공해 추가 학습. 라벨된 입출력 예시가 필수.\n\n【정답 포인트】\n▸ Fine-tuning = 지도학습 형태의 라벨 데이터 필요. (prompt, completion) 쌍 포맷이 정답.\n\n【오답 체크】\n(B) CSV·txt는 Bedrock 표준 fine-tuning 포맷 아님.\n(C) Provisioned Throughput은 추론 용량, 학습과 무관.\n(D) 원시 텍스트만으로는 fine-tuning 불가(계속 사전학습 영역).",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Anomaly Detection — 정상 패턴에서 벗어난 이벤트(이상치)를 탐지. 네트워크 보안에서 의심 IP·트래픽 탐지에 표준.\n\n【정답 포인트】\n▸ \"의심스러운 출처\" = 일반적 정상 행동에서 벗어난 것 → 이상 탐지가 정확한 패러다임.\n\n【오답 체크】\n(A) 음성 인식은 IP와 무관.\n(B) NER은 텍스트 엔티티 추출.\n(D) 사기 예측은 거래·결제 패턴용, IP 단독 평가는 이상 탐지가 직관적.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Context Window — 모델이 한 번에 처리 가능한 최대 토큰 수. 긴 문서 요약·RAG에서 핵심 지표. Claude 200K·Titan·Llama 등 모델마다 다름.\n\n【정답 포인트】\n▸ \"한 프롬프트에 들어가는 정보량\" = Context Window 그대로.\n\n【오답 체크】\n(A) Temperature는 창의성 제어.\n(C) Batch size는 학습·추론 내부 파라미터.\n(D) Model size(파라미터 수)는 성능 일반 지표, 입력 길이와 별개.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Iterative Prompt Engineering — 원하는 톤·스타일의 응답이 나올 때까지 프롬프트를 반복 조정하는 과정. 회사 톤 맞추기의 기본 접근.\n▸ 시스템 프롬프트에 톤·스타일 가이드를 넣는 것이 표준.\n\n【정답 포인트】\n▸ 톤 조정 = 프롬프트 디자인. 저비용·즉시 반영.\n\n【오답 체크】\n(A) 토큰 제한은 길이 조정만.\n(B) Batch는 대량 처리용.\n(D) Temperature↑는 오히려 일관성 약화.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Few-shot Prompting — 원하는 태스크의 예시(라벨 포함) 여러 개를 프롬프트에 넣어 모델이 패턴을 학습. 분류·추출 작업에서 정확도 크게 향상.\n\n【정답 포인트】\n▸ 라벨 붙은 예시를 보여주면 모델이 분류 패턴을 이해 → Few-shot.\n\n【오답 체크】\n(B) 이론 설명은 도움 안 됨.\n(C) Zero-shot은 정확도 낮을 수 있음.\n(D) 무관한 태스크 예시는 오히려 혼란.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS CloudTrail — AWS 계정의 API 호출을 감사 로그로 기록. 누가(IAM), 언제, 어떤 리소스에 어떤 작업을 했는지 추적. Bedrock API 호출 모두 기록됨.\n\n【정답 포인트】\n▸ 누가 Bedrock을 호출했는지 추적 = CloudTrail.\n\n【오답 체크】\n(A) Audit Manager는 컴플라이언스 프레임워크 매핑.\n(C) Fraud Detector는 이상 거래 탐지.\n(D) Trusted Advisor는 비용·성능 권고.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ SageMaker Serverless Inference — 트래픽 없으면 0으로 축소, 있을 때만 자동 확장. 인스턴스 관리 불필요. 간헐적·예측 어려운 트래픽에 최적.\n\n【정답 포인트】\n▸ \"인프라 관리 없이 모델 호스팅\" = Serverless Inference의 정의.\n\n【오답 체크】\n(B) CloudFront는 CDN.\n(C) API Gateway는 API 엔드포인트, 모델 호스팅 아님.\n(D) Batch는 배치 작업 오케스트레이션.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Artifact — AWS의 컴플라이언스 리포트(SOC·ISO·PCI 등)와 파트너·ISV 리포트 저장소. 신규 리포트 업로드 시 이메일 알림 구독 가능.\n\n【정답 포인트】\n▸ 컴플라이언스 리포트 + 알림 = Artifact의 대표 기능.\n\n【오답 체크】\n(A) Audit Manager는 내부 감사 자동화.\n(C) Trusted Advisor는 베스트 프랙티스 권고.\n(D) Data Exchange는 서드파티 데이터 마켓플레이스.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Prompt Injection — 사용자가 \"이전 지시 무시\" 같은 문구로 시스템 프롬프트를 우회하는 공격.\n▸ 방어: 시스템 프롬프트에 공격 패턴 예시와 거부 지시를 명시 → 모델이 탐지·거부.\n\n【정답 포인트】\n▸ 프롬프트 인젝션 방어의 표준 접근.\n\n【오답 체크】\n(B) Temperature↑는 오히려 예측 불가한 응답 유발.\n(C) 플랫폼 제한은 공격 방지와 무관.\n(D) 토큰 축소로 공격이 막히지 않음.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Object Detection — 이미지 속 객체의 위치(박스)와 클래스(종류)를 찾는 컴퓨터 비전 태스크. 동물 식별·분류에 표준.\n\n【정답 포인트】\n▸ 이미지 → 객체 분류 = Object Detection.\n\n【오답 체크】\n(B) 이상치 탐지.\n(C) NER은 텍스트용.\n(D) Inpainting은 이미지 일부 복원·생성.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Bedrock On-Demand — 사용한 토큰만큼만 과금. 약정 없음. 소규모·초기 프로젝트에 적합.\n▸ Provisioned Throughput — 월·6개월 등 약정으로 용량 확보. 대규모·일정 트래픽에 유리.\n\n【정답 포인트】\n▸ \"약정 없이, 저예산, 유연\" = On-Demand.\n\n【오답 체크】\n(B) Model customization은 fine-tuning, 가격 모델 아님.\n(C) Provisioned는 약정 필요.\n(D) Spot은 Bedrock 가격 모델이 아님.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ SageMaker JumpStart — 사전 학습된 FM·ML 모델을 몇 클릭으로 배포. 모델이 VPC 내 SageMaker 엔드포인트로 호스팅 → 네트워크 격리 가능.\n\n【정답 포인트】\n▸ \"팀 VPC + FM 빠른 배포\" = JumpStart.\n\n【오답 체크】\n(A) Personalize는 추천 서비스.\n(C) PartyRock은 공개 플레이그라운드, VPC 배포 아님.\n(D) Endpoints는 컴포넌트일 뿐, 모델 준비 기능 부족.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ GPT 계열 LLM — 자연어 이해와 코드·SQL 생성이 강점. Text-to-SQL은 LLM의 대표 유스케이스.\n\n【정답 포인트】\n▸ 자연어 → SQL 생성 = LLM(GPT) 영역.\n\n【오답 체크】\n(B) ResNet은 이미지 분류 CNN.\n(C) SVM은 전통적 분류기.\n(D) WaveNet은 음성 합성.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Inference (추론) — 학습된 모델이 새 데이터에 대해 예측을 내는 단계. 모델 라이프사이클 중 '사용' 단계.\n▸ Training — 가중치를 학습하는 단계.\n\n【정답 포인트】\n▸ 배포된 모델이 새 입력에 반응 = 추론.\n\n【오답 체크】\n(A) 학습은 배포 전.\n(C) 배포는 호스팅 작업.\n(D) 편향 수정은 학습·검증 단계.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Data Augmentation — 소수 클래스 샘플을 변형(회전·크롭·색변환 등)해 학습 데이터를 늘려 불균형 완화.\n▸ 편향 = 학습 데이터 불균형에서 오는 경우가 많음 → 데이터 쪽 해결이 근본적.\n\n【정답 포인트】\n▸ 데이터 편향 해결 = 데이터 증강·재샘플링.\n\n【오답 체크】\n(B) 모니터링은 감지만 하고 해결은 아님.\n(C) RAG는 지식 주입 기법.\n(D) 워터마크는 출처 증명용.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Bedrock Knowledge Bases — 회사 문서를 벡터 DB에 임베딩해 저장, 질의 시 관련 문서를 검색해 FM 프롬프트에 주입(RAG). fine-tuning 없이 사내 지식 활용.\n\n【정답 포인트】\n▸ \"사내 데이터로 보완\" = RAG = Knowledge Bases가 매니지드로 제공.\n\n【오답 체크】\n(A) 모델 교체는 사내 데이터 활용과 무관.\n(B) Temperature는 창의성.\n(D) 로깅은 관찰용.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ SageMaker Clarify — 모델의 편향·설명 가능성 리포트를 자동 생성. 예측별 피처 기여도(SHAP), 클래스 분포 편향 분석.\n\n【정답 포인트】\n▸ 투명성·설명 가능성 = Clarify가 정답.\n\n【오답 체크】\n(A) Inspector는 EC2/ECR 보안 스캔.\n(C) Macie는 S3 민감 데이터 탐지.\n(D) Rekognition 라벨은 분류 개선이지 설명 아님.",
  ...
  },
  {
    ...
    "answer": "BC",
    "explanation": "【핵심 용어】\n▸ 규제 컴플라이언스의 핵심 축 = 데이터 보호(Data Protection: 암호화·PII 처리) + 위협 탐지(Threat Detection: 보안 모니터링).\n\n【정답 포인트】\n▸ 규제(GDPR·HIPAA 등) 시연 대상 = B(위협 탐지)와 C(데이터 보호).\n\n【오답 체크】\n(A) 오토스케일링은 가용성 설계.\n(D) 비용 최적화는 재무 운영.\n(E) 마이크로서비스 결합도는 아키텍처 설계.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Epoch — 학습 데이터셋 전체를 한 번 훑는 주기. epoch이 늘수록 모델이 데이터에 더 적응 → 정확도↑ (단, 과도하면 overfit).\n\n【정답 포인트】\n▸ 정확도 향상 = 학습을 더 시키는 것 = epoch 증가.\n\n【오답 체크】\n(A) 배치 크기는 학습 안정성에 영향, 정확도 직접 개선엔 약함.\n(C) epoch↓는 학습 부족.\n(D) Temperature는 추론 단계 파라미터, 학습 정확도와 무관.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ SageMaker Clarify — ML 전주기에서 편향(bias) 탐지와 설명 가능성(explainability) 리포트 제공. 학습 전·중·후 편향 감지.\n\n【정답 포인트】\n▸ Clarify 주 용도 = 편향 탐지 + 설명 가능성.\n\n【오답 체크】\n(A) RAG는 Bedrock Knowledge Bases.\n(B) 모델 품질 모니터링은 Model Monitor.\n(C) 모델 문서화는 Model Cards.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Overfitting — 학습 데이터에만 맞춰지고 실제 데이터엔 일반화 실패. 해결: 더 많은 다양한 데이터.\n\n【정답 포인트】\n▸ 학습↔프로덕션 성능 격차 = overfitting 신호 → 데이터 양·다양성 확대.\n\n【오답 체크】\n(A) 데이터↓는 더 악화.\n(B) 하이퍼파라미터 추가는 오히려 overfit 위험.\n(D) 학습 시간↑도 overfit 위험.",
  ...
  },
  {
    ...
    "answer": "BD",
    "explanation": "【핵심 용어】\n▸ Amazon Comprehend — 텍스트에서 감정(sentiment)·엔티티·주제 자동 분석. 관리형 NLP.\n▸ Amazon Bedrock — LLM으로 맞춤 감정 분석·요약 가능.\n\n【정답 포인트】\n▸ 감정 분석 = Comprehend(기성) 또는 Bedrock(유연한 LLM 기반).\n\n【오답 체크】\n(A) Lex는 대화형 챗봇.\n(C) Polly는 TTS.\n(E) Rekognition은 이미지·비디오.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Bedrock Knowledge Bases — PDF 등 문서를 임베딩·벡터 DB에 저장 후, 질의 시 관련 청크만 자동 검색해 프롬프트에 주입(RAG). 모든 PDF를 매 요청마다 넣는 것보다 훨씬 효율적.\n\n【정답 포인트】\n▸ \"많은 문서 + 비용 효율\" = RAG(Knowledge Base).\n\n【오답 체크】\n(A) 하나만 쓰면 대부분 매뉴얼 누락.\n(B) 매 요청마다 모든 PDF 포함 = 토큰 비용 폭발.\n(C) Fine-tuning은 비용·시간 많이 듦.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Benchmark Dataset — 이미 큐레이션된 표준 평가 데이터셋(예: BOLD, ToxiGen, BBQ 등). 편향·독성 평가용 공개 데이터가 존재.\n\n【정답 포인트】\n▸ 관리 노력 최소 + 공정성 평가 = 공개 벤치마크.\n\n【오답 체크】\n(A) 사용자 콘텐츠는 라벨링 노력 큼.\n(B) 로그는 비표준.\n(C) 가이드라인은 기준 문서, 평가 데이터 아님.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Bedrock Custom Model + Provisioned Throughput — Bedrock에서 fine-tuned·continued-pretrained 커스텀 모델을 실제 추론에 사용하려면 Provisioned Throughput이 필수. On-Demand는 지원하지 않음.\n\n【정답 포인트】\n▸ Bedrock 커스텀 모델 운영 = Provisioned Throughput 구매.\n\n【오답 체크】\n(B) SageMaker 엔드포인트는 Bedrock 사용과 별개.\n(C) Model Registry는 SageMaker 개념.\n(D) '접근 권한'은 기본 모델 액세스 이야기, 커스텀 배포엔 부족.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Bedrock Model Evaluation — 사람 평가자(human evaluation) + 커스텀 데이터셋으로 주관적 품질(스타일·톤·선호) 평가. 자동 메트릭으론 측정 어려운 '선호도'를 잡을 수 있음.\n\n【정답 포인트】\n▸ \"사내 직원 선호 스타일\" = 주관적 → 사람 평가 + 자사 프롬프트.\n\n【오답 체크】\n(A) 내장 데이터셋은 일반 성능만 측정.\n(C) 공개 리더보드는 자사 스타일 반영 안 됨.\n(D) 지연시간은 품질과 무관.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Plagiarism (표절) — 타인 또는 AI가 생성한 글을 출처 없이 자기 것처럼 쓰는 행위. 학술 영역에서 주요 Responsible AI 이슈.\n\n【정답 포인트】\n▸ AI 콘텐츠 무단 복사 = 표절.\n\n【오답 체크】\n(A) Toxicity는 유해 콘텐츠.\n(B) Hallucination은 허위 생성.\n(D) Privacy는 개인정보 노출.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS Trainium (Trn 인스턴스) — AWS 자체 설계 ML 학습 전용 가속기. 같은 성능 대비 전력 효율이 GPU(P·G)보다 뛰어나 탄소 발자국 감소.\n▸ Inferentia는 추론 전용 대응 칩.\n\n【정답 포인트】\n▸ LLM 학습 + 환경 영향↓ = Trainium.\n\n【오답 체크】\n(A) C는 일반 컴퓨팅.\n(B) G는 추론·그래픽.\n(C) P는 GPU 학습, 전력 소비 큼.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Bedrock Guardrails — 입출력 콘텐츠에 대해 유해·부적절 주제 필터링, 민감 정보 마스킹, 금지 주제 차단. 어린이용·규제 환경에 필수.\n\n【정답 포인트】\n▸ 연령 적절성 보장 = Guardrails 콘텐츠 필터.\n\n【오답 체크】\n(A) Rekognition은 이미지.\n(B) Playground는 실험 UI.\n(D) Agents는 태스크 자동화.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ GAN — 생성자와 판별자가 경쟁하며 실제 같은 합성 데이터를 만듦. 이미지·테이블·음성 등 다양한 합성 데이터 생성에 활용.\n\n【정답 포인트】\n▸ 합성 데이터 생성 = GAN.\n\n【오답 체크】\n(B) XGBoost는 부스팅 분류·회귀.\n(C) ResNet은 이미지 분류.\n(D) WaveNet은 음성 합성 특화.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Sampling Bias (표본 편향) — 학습 데이터가 전체 모집단을 대표하지 못해 특정 집단에 불리하게 작동. 얼굴 인식에서 흔한 문제.\n\n【정답 포인트】\n▸ 집단별 차별적 결과 = 표본 편향(대표성 부족).\n\n【오답 체크】\n(A) 측정 편향은 수집 방법 자체의 왜곡.\n(C) 관찰자 편향은 사람이 보는 관점.\n(D) 확증 편향은 가설 확인만 수집.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Reinforcement Learning — 행동(응답) → 보상(좋은 피드백) → 정책 업데이트. 자가개선에 자연스러움.\n▸ RLHF (Reinforcement Learning from Human Feedback) — LLM 응답 품질 개선의 표준.\n\n【정답 포인트】\n▸ 스스로 개선 + 피드백 기반 = 강화학습.\n\n【오답 체크】\n(A) 정적 지도학습은 자가개선 약함.\n(C) 클러스터링은 응답 생성이 아님.\n(D) FAQ 지도학습은 수동 업데이트.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Content Moderation API — 생성된 이미지를 실시간으로 검사해 부적절(성적·폭력·혐오) 콘텐츠 차단. Rekognition Moderation·Bedrock Guardrails 등.\n\n【정답 포인트】\n▸ 부적절 출력 차단 = 모더레이션 API.\n\n【오답 체크】\n(B) 재학습은 시간·비용 큼, 근본 해결 아님.\n(C) 단발성 검증은 지속 차단 아님.\n(D) 사용자 피드백은 사후 대응.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Bedrock Model Invocation Logging — 모델의 입력 프롬프트와 출력을 S3·CloudWatch Logs로 저장하는 Bedrock 네이티브 기능. 콘텐츠 감사·품질 모니터링용.\n\n【정답 포인트】\n▸ Bedrock 입출력 로깅 = invocation logging 기능.\n\n【오답 체크】\n(A) CloudTrail은 API 호출 메타데이터만(입·출력 내용은 안 남음).\n(C) Audit Manager는 프레임워크.\n(D) EventBridge는 이벤트 라우팅.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ SageMaker Batch Transform — 대규모 일괄 데이터셋을 입력받아 예측을 S3로 내보냄. 실시간성 불필요한 분석·리포트 생성에 최적.\n\n【정답 포인트】\n▸ \"대용량 + 즉시성 불필요\" = Batch Transform.\n\n【오답 체크】\n(B) Real-time은 저지연 단건.\n(C) Serverless는 간헐 트래픽.\n(D) Asynchronous는 near-real-time(즉시는 아니지만 큐잉).",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Embedding — 단어·문장·이미지 등을 의미를 담은 고차원 벡터로 변환한 수치 표현. 벡터 공간에서 유사도·검색·RAG의 기반.\n▸ Token — 텍스트를 쪼갠 단위(subword 등). 임베딩과 구별.\n\n【정답 포인트】\n▸ '수치 표현' 명칭 = Embedding.\n\n【오답 체크】\n(B) 토큰은 쪼개진 문자 단위.\n(C) 모델은 구조 자체.\n(D) 바이너리는 파일 형식.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Domain Adaptation Fine-tuning — 특정 도메인(의학·법·과학 등)의 전문 용어·문체에 맞춰 추가 학습. 전문 용어 이해도 향상.\n▸ Continued Pre-training도 비슷한 효과.\n\n【정답 포인트】\n▸ 도메인 전문 용어 해석 한계 → 도메인 fine-tuning이 근본 해결.\n\n【오답 체크】\n(A) Few-shot은 패턴 제공, 용어 이해 근본 해결 X.\n(C) 파라미터만으론 한계.\n(D) 용어 제거는 데이터 손실.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Least Privilege — 각 주체에게 필요한 권한만. 팀마다 전용 service role로 접근 범위 한정.\n\n【정답 포인트】\n▸ 팀 경계 정확 분리 = 팀별 service role.\n\n【오답 체크】\n(B) 요청 시 지정은 권한이 아니라 애플리케이션 로직 — 우회 가능.\n(C) 마스킹은 원본 보호 아님.\n(D) Bedrock에 전역 권한 주면 격리 무너짐.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Bedrock Guardrails — 입·출력에서 PII·민감 정보 자동 마스킹. 위반 이벤트를 CloudWatch Metrics로 내보냄 → Alarm으로 알림.\n\n【정답 포인트】\n▸ PII 차단 + 알림 = Guardrails + CloudWatch Alarm.\n\n【오답 체크】\n(A) Macie는 S3 대상이지 Bedrock 응답 실시간 필터 아님.\n(B) CloudTrail은 API 콜 로그.\n(D) Model Monitor는 품질 드리프트.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon Textract — PDF·이미지에서 텍스트·표·폼을 자동 추출(OCR++). 이력서·계약서·청구서 처리 표준.\n\n【정답 포인트】\n▸ PDF → 텍스트 = Textract.\n\n【오답 체크】\n(B) Personalize는 추천.\n(C) Lex는 챗봇.\n(D) Transcribe는 음성→텍스트.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ System Prompt / Role Prompting — \"당신은 초등학생을 대상으로 설명합니다\" 같은 역할 지시를 프롬프트에 넣는 것만으로 스타일·난이도 조정 가능. 코드·학습 불필요.\n\n【정답 포인트】\n▸ 최소 노력 + 스타일 제어 = 프롬프트 역할 부여.\n\n【오답 체크】\n(A) Fine-tuning은 데이터·시간·비용 큼.\n(C) CoT는 추론 절차 개선, 연령별 스타일과 직접 매칭 약함.\n(D) 요약만으론 스타일 조정 불충분.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ EDA (Exploratory Data Analysis) — 본 학습 전 데이터 특성을 탐색·이해하는 단계. 통계·시각화·상관관계가 주 활동.\n\n【정답 포인트】\n▸ 시각화·상관 분석 = EDA.\n\n【오답 체크】\n(A) 전처리는 클리닝·인코딩.\n(B) 피처 엔지니어링은 새 피처 생성.\n(D) 하이퍼파라미터 튜닝은 학습 단계.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ BERT (Bidirectional Encoder Representations from Transformers) — 양방향 컨텍스트로 마스크된 토큰 예측(Masked Language Modeling)에 특화. 빈칸 채우기(cloze task)가 원래 학습 목적.\n\n【정답 포인트】\n▸ 빈칸 채우기 = BERT의 정답 용도.\n\n【오답 체크】\n(A) Topic modeling은 주제 추출.\n(B) Clustering은 그룹화.\n(C) Prescriptive은 행동 권고.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon Q in QuickSight — BI 대시보드에 자연어 질의로 차트·그래프를 생성. \"지난 12개월 매출 보여줘\" → 즉시 시각화.\n\n【정답 포인트】\n▸ 매출 그래프 자동 = Q in QuickSight.\n\n【오답 체크】\n(A) EC2용 Q는 일반 운영.\n(B) Developer는 코딩.\n(D) Chatbot은 Slack 등 메시징.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Intent Detection — 사용자 발화(문장)을 사전 정의된 인텐트 카테고리로 분류.\n▸ Few-shot 학습 = (입력, 라벨) 쌍 필요. 여기서 입력 = 사용자 메시지, 라벨 = 인텐트.\n\n【정답 포인트】\n▸ (사용자 메시지, 인텐트) 쌍이 few-shot 예시.\n\n【오답 체크】\n(A) 챗봇 응답은 입력이 아님.\n(B) (메시지, 응답) 쌍은 응답 생성 학습.\n(D) (인텐트, 응답)은 응답 생성용.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Bedrock 과금 = 입력·출력 토큰 수 × 단가. 프롬프트 축소 = 직접 비용 감소.\n\n【정답 포인트】\n▸ 비용 절감 = 토큰 축소.\n\n【오답 체크】\n(A) Fine-tuning은 초기 비용 큼.\n(C) 토큰↑는 비용↑.\n(D) Provisioned는 대규모 트래픽에서만 이득.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ BLEU — 번역 평가의 표준. 기계 번역과 참조 번역의 n-gram 일치도 측정.\n▸ ROUGE — 주로 요약 평가.\n\n【정답 포인트】\n▸ 번역 품질 = BLEU.\n\n【오답 체크】\n(B) RMSE는 회귀.\n(C) ROUGE는 요약.\n(D) F1은 분류.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Bedrock Agents — LLM + 외부 API·데이터 소스 호출 + 다단계 워크플로 자동 수행. 주문 조회, 환불 처리 같은 반복 작업 자동화에 최적.\n\n【정답 포인트】\n▸ Agents 핵심 = 반복 작업 자동화 + 워크플로 오케스트레이션.\n\n【오답 체크】\n(A) FM 생성은 SageMaker 영역.\n(C) 여러 FM 호출은 주요 설계 포인트가 아님.\n(D) 선택은 사람이 함.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Continued/Ongoing Pre-training — 최신 데이터를 FM에 계속 주입해 도메인 지식·최신성을 유지. 장기적으로 모델 품질 향상.\n\n【정답 포인트】\n▸ 최신 데이터 반영 → 시간에 따른 성능 개선.\n\n【오답 체크】\n(A) 복잡도와 무관.\n(C) 오히려 추가 학습 필요.\n(D) 추론 속도는 아키텍처 이슈.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Token — LLM이 처리하는 최소 단위. 영어 기준 대략 1 단어 ≈ 1~1.3 토큰. 한국어는 글자/음절 단위로 더 많이 쪼개짐.\n\n【정답 포인트】\n▸ 토큰 정의 = 입출력 기본 단위.\n\n【오답 체크】\n(B) 수학적 표현 = Embedding.\n(C) 가중치는 파라미터.\n(D) 지시는 프롬프트.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ VPC Endpoint for S3 — SageMaker Studio가 VPC 안에서 S3에 프라이빗 경로로 접근. 네트워크 흐름 통제 + 인터넷 노출 제거.\n\n【정답 포인트】\n▸ 데이터 흐름 관리 + 보안 = VPC + S3 Endpoint.\n\n【오답 체크】\n(A) Inspector는 취약점 스캔.\n(B) Macie는 민감 데이터 탐지.\n(D) Glacier는 아카이브 스토리지.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon S3 — Bedrock이 학습·평가 데이터셋을 읽는 표준 스토리지. 검증·평가 JSONL 파일을 S3에 업로드 후 참조.\n\n【정답 포인트】\n▸ Bedrock 데이터 소스 = S3.\n\n【오답 체크】\n(B) EBS는 EC2 블록 스토리지.\n(C) EFS는 공유 파일 시스템.\n(D) Snowcone은 엣지 물리 장치.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Jailbreak — 모델의 안전 가드레일을 우회해 금지된 응답을 끌어내려는 공격/테스트. \"DAN 모드\", \"롤플레잉\" 등 기법.\n\n【정답 포인트】\n▸ 안전장치 우회 시도 = Jailbreak.\n\n【오답 체크】\n(A) 퍼징은 취약점 자동 탐색.\n(B) DoS는 가용성 공격.\n(C) 침투 테스트는 일반 용어 — 더 구체적 용어가 jailbreak.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ SageMaker Network Isolation — 학습·추론 컨테이너의 외부 네트워크 접근을 차단. VPC·PrivateLink와 결합해 인터넷 없이 동작.\n\n【정답 포인트】\n▸ 인터넷 없이 격리 실행 = Network Isolation.\n\n【오답 체크】\n(A) Experiments는 실험 추적.\n(C) Geospatial은 지리 데이터 처리.\n(D) IAM은 인증·인가만 제공.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ SageMaker Model Cards — 모델 용도·학습 데이터·성능·제약을 표준 양식으로 문서화. 거버넌스·감사 요구 충족.\n▸ AI Service Cards = AWS 서비스(Rekognition 등)에 관한 AWS가 제공하는 문서.\n\n【정답 포인트】\n▸ 커스텀 모델 감사 = Model Cards.\n\n【오답 체크】\n(A) 자유 문서는 표준화 부족.\n(B) AI Service Cards는 AWS 제공 서비스용.\n(D) Git은 코드 버전, 감사 메타데이터 부족.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Class Imbalance — 특정 집단의 샘플이 적으면 모델이 해당 집단에 약함. 측정 후 재샘플링·가중치 조정으로 완화.\n\n【정답 포인트】\n▸ 편향 없애기 = 불균형 측정 + 학습 조정.\n\n【오답 체크】\n(A) 데이터 축소는 악화.\n(B) 과거 편향 이어받음.\n(C) 집단별 모델은 차별 소송 리스크 큼.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Adversarial Prompting — 잠재 공격 시나리오를 프롬프트에 미리 넣고 모델이 탐지·거부하도록 훈련·지시하는 방어 기법.\n\n【정답 포인트】\n▸ 인젝션 방어 = Adversarial prompting 설계.\n\n【오답 체크】\n(B) Zero-shot은 기본 프롬프팅.\n(C) Least-to-most는 복잡 문제 쪼개기.\n(D) CoT는 추론 개선.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ F1 Score — Precision과 Recall의 조화평균. 분류·QA 태스크에서 균형 잡힌 품질 평가에 표준.\n\n【정답 포인트】\n▸ fine-tuning 정확도 평가 = F1 (Precision+Recall 균형).\n\n【오답 체크】\n(A) Precision만으론 recall 반영 X.\n(B) Time to first token은 지연.\n(D) WER은 음성 인식.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ CFG Scale — 프롬프트를 모델이 얼마나 엄격히 따르게 할지 제어. 높이면 프롬프트와 결과 유사도↑ (하지만 너무 높이면 아티팩트).\n\n【정답 포인트】\n▸ 특정성 = CFG scale↑.\n\n【오답 체크】\n(A) Step↑는 품질·디테일 일반 개선, 특정성 직접 제어 아님.\n(B) 마스크는 인페인팅.\n(D) prompt strength는 이미지-투-이미지용.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Fairness — 모델이 모든 인구통계 집단에 공평히 작동하도록 학습 데이터를 다양화·균형화.\n\n【정답 포인트】\n▸ 다양한 집단 포함 = 공정성(Fairness) 실천.\n\n【오답 체크】\n(B) Explainability는 설명성.\n(C) Governance는 정책 체계.\n(D) Transparency는 정보 공개.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ SageMaker Clarify — 편향 탐지 + SHAP 기반 예측 설명 리포트. '편향 + 설명성'이 요구되면 정답.\n\n【정답 포인트】\n▸ 편향 + 설명 = Clarify.\n\n【오답 체크】\n(B) Data Wrangler는 전처리.\n(C) Model Cards는 문서.\n(D) AI Service Cards는 AWS 제공 서비스용 문서.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ BERTScore — 생성된 요약과 참조 요약의 의미 유사도를 BERT 임베딩으로 측정. 요약 품질의 대표 자동 지표.\n\n【정답 포인트】\n▸ 생성형 요약 자동 평가 = BERTScore.\n\n【오답 체크】\n(A) AUC는 분류.\n(B) F1은 분류·QA.\n(D) RWK는 표준 지표 아님.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ k-NN — 가장 가까운 k개 이웃의 라벨 다수결로 분류. Iris 데이터셋의 전형적 예제.\n\n【정답 포인트】\n▸ 다중 피처 분류 = k-NN.\n\n【오답 체크】\n(B) K-means는 클러스터링(비지도).\n(C) ARIMA는 시계열.\n(D) Linear Regression은 회귀.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS KMS — 암호화 키 생성·관리·회전. 고객 관리형 키(CMK)로 S3·Bedrock 산출물 암호화 가능.\n\n【정답 포인트】\n▸ 사용자 관리 암호화 키 = KMS.\n\n【오답 체크】\n(B) Inspector는 취약점 스캔.\n(C) Macie는 민감 데이터 분류.\n(D) Secrets Manager는 비밀번호·API 키.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Text Generation — 프롬프트를 받아 새 텍스트(코드 포함)를 생성하는 LLM의 핵심 기능. 코드 생성도 텍스트 생성의 하위 유스케이스.\n\n【정답 포인트】\n▸ 주석→코드 = 생성.\n\n【오답 체크】\n(A) 요약은 축약.\n(C) Completion은 이어 쓰기(부분집합).\n(D) Classification은 라벨 예측.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ ROUGE — 생성된 텍스트와 참조 텍스트의 n-gram·부분수열 겹침 측정. 요약·재작성 평가의 표준.\n\n【정답 포인트】\n▸ 참조 예시와 유사성 평가 = ROUGE.\n\n【오답 체크】\n(A) Loss는 학습 내부 지표.\n(B) Semantic robustness는 공격 내성.\n(D) 지연은 성능 지표.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ 카테고리별 템플릿 프롬프트 — 제품 유형에 맞춘 템플릿 + 출력 형식(길이·톤) 명시가 확장성과 일관성 확보.\n\n【정답 포인트】\n▸ 일관된 형식 + 효율 = 카테고리별 템플릿.\n\n【오답 체크】\n(A) 사후 편집은 비용.\n(C) 다양성 포함은 초점 흐림.\n(D) 제품마다 개별 프롬프트는 확장성 낮음.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Overfitting — 학습 데이터에만 맞음. 해결: 모델 복잡도 ↓ (정규화 L1/L2 강화).\n\n【정답 포인트】\n▸ Overfit 완화 = 정규화↑.\n\n【오답 체크】\n(A) 복잡도↑는 악화.\n(C) 피처↑도 overfit 가능.\n(D) Epoch↑도 overfit 위험.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Aurora PostgreSQL + pgvector — 벡터 임베딩 저장 + nearest neighbor 검색 지원. Amazon OpenSearch도 대안.\n\n【정답 포인트】\n▸ 관계형 DB 기반 벡터 DB = Aurora PostgreSQL.\n\n【오답 체크】\n(A) Athena는 S3 SQL 쿼리.\n(C) Redshift는 DW.\n(D) EMR은 빅데이터 플랫폼.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ 리뷰 요약 = LLM의 대표 유스케이스. Bedrock Claude·Titan 등.\n\n【정답 포인트】\n▸ 텍스트 요약 = LLM(Bedrock).\n\n【오답 체크】\n(A) Personalize는 추천.\n(C) 분류는 요약 아님.\n(D) Rekognition은 이미지.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ ML Lifecycle — 비즈니스 목표 → 데이터 수집 → EDA/전처리 → 피처 엔지니어링 → 모델 학습 → 평가 → 배포 → 모니터링 → (재학습).\n\n【정답 포인트】\n▸ 표준 단계 순서 숙지.\n\n【참고】 원본은 HOTSPOT(드래그)이며 본 퀴즈에선 객관식으로 단순화. ExamTopics 원문 참고 권장.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Supervised Learning — 라벨이 있는 데이터로 분류·회귀 학습. 라벨 있는 이미지 셋이 이미 있다면 가장 적합.\n\n【정답 포인트】\n▸ 라벨 있는 대규모 데이터 = 지도학습.\n\n【오답 체크】\n(B) 비지도는 라벨 없음.\n(C) 강화는 보상 기반.\n(D) Active는 라벨 우선순위 학습(추가 라벨링 전제).",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ SageMaker Endpoints — 관리형 추론 호스팅. 서버 OS·패치 관리 불필요. Serverless·Real-time 선택 가능.\n\n【정답 포인트】\n▸ 관리형 모델 호스팅 = SageMaker Endpoint.\n\n【오답 체크】\n(A) EC2는 관리 부담.\n(B) EKS는 컨테이너 클러스터 관리.\n(C) CloudFront는 CDN.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Bedrock Agents + Knowledge Bases — 에이전트가 API(클레임 조회)를 호출 + 문서 KB에서 관련 자료 검색(RAG). 업무용 복합 워크플로에 최적.\n\n【정답 포인트】\n▸ 태스크 실행 + 문서 검색 = Agents + KB.\n\n【오답 체크】\n(A) Fraud Detector는 사기 탐지.\n(C) Personalize는 추천.\n(D) 새 ML 모델은 과잉.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Computer Vision — 이미지·비디오에서 객체·결함·패턴 인식. 품질 검사·제조 결함 탐지의 표준 AI 분야.\n\n【정답 포인트】\n▸ 이미지로 결함 탐지 = Computer Vision.\n\n【오답 체크】\n(A) 추천은 사용자-아이템.\n(B) NLP는 텍스트.\n(D) 이미지 프로세싱은 전통적 필터링(AI보다 하위 개념).",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ SageMaker Automatic Model Tuning (AMT) — 하이퍼파라미터 자동 최적화(Bayesian·랜덤·grid). 직접 튜닝 없이 최적 모델 탐색.\n\n【정답 포인트】\n▸ 자동 튜닝 = SageMaker AMT.\n\n【오답 체크】\n(A) Personalize는 추천 전용.\n(C) Athena는 SQL.\n(D) Comprehend는 NLP.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Bias Mitigation via Data Diversification — 불균형한 학습 데이터를 보완해 fine-tuning을 반복. 새 모델 학습 대비 저비용.\n\n【정답 포인트】\n▸ 기존 fine-tuned 모델의 편향 수정 = 데이터 다양화 + 재 fine-tuning.\n\n【오답 체크】\n(B) RAG는 최신 지식 주입, 편향 근본 해결 아님.\n(C) Trusted Advisor는 AWS 운영 권고.\n(D) 새 모델 사전학습은 최대 비용.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Inference Modes 선택 기준: 실시간 응답 필요 → Real-time. 대규모 오프라인 → Batch. 간헐 트래픽 → Serverless. 대용량+near-real-time → Async.\n\n【정답 포인트】\n▸ 유스케이스마다 다른 모드 매칭.\n\n【참고】 HOTSPOT 원본은 드래그 매칭 형식. ExamTopics 원문 참고.",
  ...
  },
  {
    ...
    "answer": "AD",
    "explanation": "【핵심 용어】\n▸ CloudTrail — API 호출 감사 로그.\n▸ S3 Intelligent-Tiering — 접근 패턴 기반 자동 저비용 계층 이동. 장기 보관 최저 비용.\n\n【정답 포인트】\n▸ API 로그 → CloudTrail. 5년 저비용 저장 → S3 IT.\n\n【오답 체크】\n(B) CloudWatch는 단기 메트릭·로그.\n(C) Audit Manager는 리포팅.\n(E) S3 Standard는 상시 접근 고비용.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon Personalize — 실시간 개인화 추천 관리형 서비스. 사용자 행동 데이터로 상품·콘텐츠 개인화.\n\n【정답 포인트】\n▸ 개인화 추천 = Personalize.\n\n【오답 체크】\n(B) Kendra는 엔터프라이즈 검색.\n(C) Rekognition은 이미지.\n(D) Transcribe는 음성.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon CloudWatch — 메트릭·로그·알람 통합 모니터링. SageMaker·Bedrock 런타임 성능 모니터링 표준.\n\n【정답 포인트】\n▸ 확장 가능한 성능 모니터링 = CloudWatch.\n\n【오답 체크】\n(B) CloudTrail은 API 감사.\n(C) Trusted Advisor는 권고.\n(D) Config는 리소스 구성 이력.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Chain-of-Thought (CoT) — \"단계별로 생각해봐\" 지시로 모델이 중간 추론을 출력하게 유도. 수학·논리 문제 정확도 크게 향상.\n\n【정답 포인트】\n▸ 단계별 사고 요구 = CoT.\n\n【오답 체크】\n(B) 인젝션은 공격.\n(C) Few-shot은 예시 제공.\n(D) Templating은 템플릿 재사용.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon Bedrock — 여러 FM 벤더(Anthropic, Cohere, Meta, Amazon 등)의 모델을 API로 제공. 생성형 AI 앱의 표준 진입점.\n\n【정답 포인트】\n▸ FM 접근 = Bedrock.\n\n【오답 체크】\n(A) Q Developer는 IDE 도우미.\n(C) Kendra는 검색.\n(D) Comprehend는 NLP.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ CoT는 다단계 논리 문제 해결에 특화. '단계별 설명'이 명시된 요구 = CoT.\n\n【정답 포인트】\n▸ 추론 + 단계 설명 = CoT.\n\n【오답 체크】\n(A) Few-shot은 예시.\n(B) Zero-shot은 기본.\n(C) Directional은 힌트형.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ ML 3대 패러다임 = Supervised(라벨), Unsupervised(라벨X), Reinforcement(보상).\n\n【정답 포인트】\n▸ 유스케이스 맞춤 패러다임 매칭.\n\n【참고】 HOTSPOT 드래그 매칭 원본. ExamTopics 원문 참고.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Temperature↓ → 모델이 확률 높은 '안전한' 토큰 선택 → 창작 감소 → 환각 확률 ↓.\n▸ 더 근본 해결은 RAG·팩트체크지만, 파라미터 조정으로도 일정 효과.\n\n【정답 포인트】\n▸ 파라미터로 환각 감소 = Temperature↓.\n\n【오답 체크】\n(A) Agents는 작업 오케스트레이션.\n(B) 사전 데이터 제거는 학습 단계.\n(D) 완전 환각 없는 FM은 존재하지 않음.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ LLM은 stateless. 대화 맥락은 매 요청마다 이전 대화를 프롬프트에 함께 전달해야 유지됨. (Conversation History Management).\n\n【정답 포인트】\n▸ 멀티턴 맥락 = 프롬프트에 히스토리 포함.\n\n【오답 체크】\n(A) 로깅은 저장만.\n(C) Personalize는 추천.\n(D) PT는 용량.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ 생성형 AI(설명·추천 생성) = Bedrock FM 영역.\n\n【정답 포인트】\n▸ 맞춤 제품 설명 생성 = Bedrock.\n\n【오답 체크】\n(A) Macie는 민감 데이터.\n(B) Transcribe는 음성→텍스트.\n(D) Textract는 문서 OCR.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Prompt 기법: Zero-shot(예시 0), Few-shot(예시 2-10), CoT(단계 사고), Least-to-most(점진 쪼개기).\n\n【정답 포인트】\n▸ 패턴별 매칭 이해.\n\n【참고】 HOTSPOT 드래그 매칭. 원문 참고.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Bedrock Guardrails 종류: Content filters(증오·폭력·성적·욕설), Denied topics(금지 주제), Sensitive info(PII), Word filters(특정 단어).\n\n【정답 포인트】\n▸ 각 위협별 적절한 필터 종류 숙지.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "AB",
    "explanation": "【핵심 용어】\n▸ Audit Manager — 컴플라이언스 프레임워크(PCI·ISO·SOC) 매핑 + 감사 증거 자동 수집.\n▸ AWS Config — 리소스 구성 이력·규정 평가.\n\n【정답 포인트】\n▸ 컴플라이언스 평가 = Audit Manager + Config.\n\n【오답 체크】\n(C) Inspector는 취약점.\n(D) CloudWatch는 모니터링.\n(E) CloudTrail은 API 감사.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon Translate — 관리형 기계 번역(100+ 언어). 실시간·배치 번역 모두 지원.\n\n【정답 포인트】\n▸ 다국어 번역 = Translate.\n\n【오답 체크】\n(B) Transcribe는 음성→텍스트.\n(C) Kendra는 검색.\n(D) Polly는 TTS.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ FM 커스터마이즈 3단계: RAG(지식 주입), Fine-tuning(행동 조정), Continued pre-training(도메인 적응).\n\n【정답 포인트】\n▸ 상황별 올바른 방법 선택.\n\n【참고】 HOTSPOT 원문 참고.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Model Cards = 거버넌스·감사용 모델 메타데이터 문서.\n\n【정답 포인트】\n▸ 거버넌스 문서 = Model Cards.\n\n【오답 체크】\n(B) Debugger는 학습 이슈 디버그.\n(C) Monitor는 드리프트.\n(D) JumpStart는 모델 카탈로그.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon Comprehend Medical — 의료 엔티티(약물·질환·증상) 추출 + 관계 분석 특화. HIPAA 적격.\n\n【정답 포인트】\n▸ 의료 엔티티 추출 = Comprehend Medical.\n\n【오답 체크】\n(B) Personalize는 추천.\n(C) Textract는 스캔 이미지 기반, 구조화 데이터엔 과함.\n(D) Kendra는 검색.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Embedding — 객체(단어·문장·이미지)를 저·중차원 벡터로 의미를 보존하며 표현. 검색·유사도·RAG의 기반.\n\n【정답 포인트】\n▸ 수치적 의미 표현 = Embedding.\n\n【오답 체크】\n(A) 압축과 다름.\n(B) 암호화 아님.\n(C) 시각화는 응용일 뿐.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Bedrock + Knowledge Bases = 관리형 RAG. 코드 거의 없이 지식 베이스 연동된 챗봇 구축.\n\n【정답 포인트】\n▸ 최소 개발 + 지식베이스 챗봇 = Bedrock RAG.\n\n【오답 체크】\n(A) Autopilot은 표 데이터 자동 ML.\n(C) Q Developer는 코딩 도우미.\n(D) Fine-tune은 시간·비용 큼.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Self-Attention — Transformer의 핵심. 문장 내 모든 토큰 간 상호 관계를 병렬 계산해 장거리 의존성 포착.\n\n【정답 포인트】\n▸ Transformer 특성 = Self-Attention.\n\n【오답 체크】\n(A) CNN 기술.\n(B) 멀티모달 Transformer도 존재.\n(D) RNN 방식.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Prompt Chaining — 큰 작업을 단계별 프롬프트로 쪼개 이전 출력 → 다음 입력으로 전달. 복잡 추론·리팩토링에 효과적.\n\n【정답 포인트】\n▸ 순차 서브태스크 = Prompt Chaining.\n\n【오답 체크】\n(A) 예시 1개.\n(C) Tree of thoughts는 병렬 탐색.\n(D) RAG는 지식 검색.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ RAG — 최신 재고 DB를 질의 시 검색해 응답 생성. 학습 없이 최신 데이터 활용.\n\n【정답 포인트】\n▸ 자주 변하는 데이터 = RAG.\n\n【오답 체크】\n(A) 전이학습은 학습 필요.\n(B) 연합학습은 분산 학습.\n(D) One-shot은 예시 기반.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Model Cards — 공식 모델 문서·버전·성능·책임 기록. 다기관 공유 표준 양식.\n\n【정답 포인트】\n▸ ML 표준 문서화 = Model Cards.\n\n【오답 체크】\n(A) Git은 코드 버전만.\n(B) Fraud Detector는 사기.\n(D) Comprehend는 NLP.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Model Monitor — 배포 모델 품질·데이터 드리프트·편향 지속 모니터링.\n\n【정답 포인트】\n▸ 품질 변화 감지 = Model Monitor.\n\n【오답 체크】\n(A) JumpStart는 모델 카탈로그.\n(B) HyperPod는 대규모 학습.\n(C) Data Wrangler는 전처리.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Bedrock On-Demand — 약정 없음, 사용량만큼 과금. 불규칙·소량 트래픽 최적.\n\n【정답 포인트】\n▸ 예측 불가 트래픽 + 비용 최소 = On-Demand.\n\n【오답 체크】\n(A) EC2 GPU는 상시 비용.\n(B) Provisioned는 약정.\n(D) JumpStart는 모델 배포, 추론 비용 모델과 별개.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Denied Topics — 금지 주제(정치·종교 등 특정 테마)를 프롬프트·응답에서 탐지·차단.\n\n【정답 포인트】\n▸ 정치적 주제 필터 = Denied topics.\n\n【오답 체크】\n(A) Word filter는 특정 단어.\n(C) Sensitive info는 PII.\n(D) Content filter는 폭력·증오.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Precision = TP / (TP + FP). 플래그된 것 중 실제 사기 비율. FP(잘못된 플래그) 줄이기 = Precision↑.\n\n【정답 포인트】\n▸ 잘못된 경고 최소화 = Precision.\n\n【오답 체크】\n(A) Recall은 놓치지 않기.\n(B) Accuracy는 전체 정확.\n(D) Lift chart는 마케팅 반응 분석.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Citation / Source Links — 응답과 함께 근거 문서 링크 제공 → 사용자가 검증 가능, 신뢰 향상. RAG 구현의 핵심 UX.\n\n【정답 포인트】\n▸ 근거 제시 = 출처 링크.\n\n【오답 체크】\n(A) 신뢰 점수는 기술적.\n(C) 아바타는 UI.\n(D) 스타일은 톤만.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Fine-tuning — 라벨된 데이터로 특정 태스크·도메인에 맞춰 모델 재조정. 산업별 용어 적응의 표준.\n\n【정답 포인트】\n▸ 라벨 데이터 + 산업 적응 = Fine-tuning.\n\n【오답 체크】\n(A) 증강은 데이터 확장.\n(C) 양자화는 크기 축소.\n(D) Continued pre-training은 비라벨 데이터.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Instruction Fine-tuning — (instruction/question, response) 쌍으로 모델에 원하는 입출력 패턴을 학습. 도메인 QA 특화 모델 만들기.\n\n【정답 포인트】\n▸ 질문-답변 쌍 = Instruction fine-tuning 데이터.\n\n【오답 체크】\n(A) 병합 원문은 continued pre-training용.\n(B) 감정 라벨은 감정분석용.\n(D) Few-shot은 학습이 아니라 프롬프트.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ 커스터마이즈 3축: Fine-tuning(행동), RAG(지식), Continued pre-training(도메인 심화).\n\n【정답 포인트】\n▸ 요구별 올바른 기법 매칭.\n\n【참고】 HOTSPOT 원문 참고.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Binary Classification — 두 클래스(예/아니오) 분류. 사기 탐지의 표준.\n\n【정답 포인트】\n▸ 2개 클래스 = 이진 분류.\n\n【오답 체크】\n(A) 회귀는 연속값.\n(B) Diffusion은 생성.\n(D) 다중 클래스는 3개 이상.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Responsible AI 특성: Fairness, Explainability, Privacy, Safety, Robustness, Transparency.\n\n【정답 포인트】\n▸ 액션과 원칙 매칭.\n\n【참고】 HOTSPOT 원문 참고.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS HealthScribe — 의료 대화 자동 전사·요약·임상 노트 생성. HIPAA 적격, SOAP 포맷 요약.\n\n【정답 포인트】\n▸ 임상 노트 받아쓰기 = HealthScribe.\n\n【오답 체크】\n(A) Q Developer는 개발자.\n(B) Polly는 TTS.\n(C) Rekognition은 이미지.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Regression — 연속 숫자 예측(가격·수요·온도). 분류와 대비되는 지도학습 패러다임.\n\n【정답 포인트】\n▸ 숫자 예측 = Regression.\n\n【오답 체크】\n(A) Diffusion은 이미지 생성.\n(C) Transformer는 아키텍처.\n(D) Multi-modal은 다중 입력.",
    "en_q": "Which type of AI model makes numeric predictions?",
    "en_opts": {
      "A": "Diffusion",
      "B": "Regression",
      "C": "Transformer",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ SageMaker 주요 기능: Canvas(노코드), JumpStart(사전학습 모델), Clarify(편향·설명), Model Monitor(드리프트), Feature Store(피처 공유).\n\n【정답 포인트】\n▸ 기능별 용도 매칭.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Vector Embedding — 텍스트 의미를 벡터화해 코사인 유사도·거리 계산. 유사 문서 검색·RAG의 수학적 기반.\n\n【정답 포인트】\n▸ 의미적 비교 수학화 = Embedding.\n\n【오답 체크】\n(A) 분할은 chunking.\n(B) 그룹화는 tokenization.\n(D) 단어 수는 token count.",
  ...
  },
  {
    ...
    "answer": "BC",
    "explanation": "【핵심 용어】\n▸ Bedrock은 AWS 관리형, Region 내 처리 → 데이터가 해당 Region에 머무름.\n▸ PrivateLink + VPC → 트래픽 인터넷 미경유.\n\n【정답 포인트】\n▸ Region 내 + 비공개 경로 = Bedrock + PrivateLink.\n\n【오답 체크】\n(A) Outposts는 과도.\n(D) 불가능.\n(E) 로그는 보안과 직접 관련 없음.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Artifact — AWS 컴플라이언스 리포트(SOC·ISO·PCI 등) 다운로드 포털. 규제 준수 증빙.\n\n【정답 포인트】\n▸ 컴플라이언스 리포트 = Artifact.\n\n【오답 체크】\n(A) Macie는 데이터 탐지.\n(C) Secrets Manager는 비밀 관리.\n(D) Config는 구성 추적.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ BLEU(또는 ROUGE)는 번역·요약 평가의 표준. 참조 텍스트와의 n-gram 일치도. 요약은 ROUGE가 더 일반적이지만 BLEU도 사용.\n\n【정답 포인트】\n▸ 요약 평가 = BLEU/ROUGE 계열.\n\n【오답 체크】\n(A) F1은 분류.\n(C) Accuracy는 분류.\n(D) MSE는 회귀.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Fine-tuning — 사전학습 모델에 태스크 전용 라벨 데이터로 추가 학습. 해당 태스크 성능 개선.\n\n【정답 포인트】\n▸ 특정 태스크 성능↑ = Fine-tuning.\n\n【오답 체크】\n(A) 크기 축소 아님.\n(B) 처음부터 재학습 아님(점진 학습).\n(C) Continued pre-training.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Bedrock Fine-tuning — 100개 대화 예시로도 충분한 톤 학습 가능. 가장 직관적 경로.\n\n【정답 포인트】\n▸ 예시 데이터 기반 톤 조정 = Fine-tuning.\n\n【오답 체크】\n(A) Personalize는 추천.\n(B) 사전학습은 과도.\n(C) TensorRT는 추론 최적화.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Multi-modal LLM — 텍스트·이미지 동시 입력 처리 + 텍스트 응답 생성. Claude 3, GPT-4V 등.\n\n【정답 포인트】\n▸ 텍스트+이미지 QA = Multi-modal LLM.\n\n【오답 체크】\n(A) CV는 이미지만.\n(C) Diffusion은 생성.\n(D) TTS는 음성 출력.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Embedding — 객체의 의미를 고차원 벡터 공간에 매핑. 벡터 간 거리·방향이 의미 유사도 반영.\n\n【정답 포인트】\n▸ 의미 벡터 표현 = Embedding 정의.\n\n【오답 체크】\n(B) RAG 설명.\n(C) Quantization 설명.\n(D) Vector DB.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Inference Speed — 추론 응답 속도. 실시간 앱에선 가장 중요한 지표. 작은 모델이 빠름.\n\n【정답 포인트】\n▸ 실시간 = Inference speed.\n\n【오답 체크】\n(A) 복잡도는 내부.\n(B) 혁신 속도는 벤더 지표.\n(D) 학습 시간은 실시간과 무관.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Balanced & Diverse Data — 성별·연령·지역 다양성을 확보한 데이터가 편향 감소의 기본.\n\n【정답 포인트】\n▸ 편향↓ = 다양성·균형.\n\n【오답 체크】\n(A) 기존 데이터 편향 재생산.\n(B) 비구매자 제외 편향.\n(D) 공개 데이터도 편향 가능.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Accuracy = (TP+TN) / (전체). 전체 기준 정확히 분류한 비율.\n\n【정답 포인트】\n▸ 총 정분류 비율 = Accuracy 정의.\n\n【오답 체크】\n(B) Precision = TP/(TP+FP).\n(C) F1은 조화평균.\n(D) Recall = TP/(TP+FN).",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ IAM Resource-level Policy — Bedrock 모델별 Action(InvokeModel)에 Allow/Deny. 가장 정밀하고 표준적인 접근 제한.\n\n【정답 포인트】\n▸ Bedrock 모델 접근 제어 = IAM 정책.\n\n【오답 체크】\n(B) STS는 임시 자격 발급.\n(C) Service role은 구독이 아님.\n(D) Inspector는 보안 스캔.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Supervised Learning — (입력, 라벨) 쌍으로 학습. 분류·회귀.\n\n【정답 포인트】\n▸ 라벨 있음 = Supervised.\n\n【오답 체크】\n(B) 라벨 없음.\n(C) 보상 기반.\n(D) 사전학습 모델 전이.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Top K — 매 단계 확률 상위 K개 토큰만 후보로 샘플링. K↓ = 보수적, K↑ = 다양.\n▸ Top P (nucleus)도 유사.\n\n【정답 포인트】\n▸ 후보 수 제어 = Top K.\n\n【오답 체크】\n(A) Max tokens는 길이.\n(C) Temperature는 분포.\n(D) Batch size는 처리량.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Text Embedding Model — 텍스트를 벡터로 변환하는 전용 FM. Titan Embeddings, Cohere Embed 등.\n\n【정답 포인트】\n▸ 텍스트 → 벡터 = Embedding model.\n\n【오답 체크】\n(A) Completion은 생성.\n(B) Instruction은 일반 LLM.\n(D) Image generation은 이미지.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Few-shot — 예시 2~여러 개를 제공해 모델이 형식·톤을 학습. 일관된 출력 형식 맞추기에 표준.\n\n【정답 포인트】\n▸ 형식 예시 여러 개 = Few-shot.\n\n【오답 체크】\n(A) Zero-shot은 예시 없음.\n(B) CoT는 추론.\n(C) One-shot은 예시 1개.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ PII Scrubbing before Fine-tuning — 학습 데이터에 개인정보가 포함되면 모델이 내재화 → 배포 후 유출 가능. 사전 제거가 근본 해결.\n\n【정답 포인트】\n▸ fine-tune 데이터의 PII 사전 제거.\n\n【오답 체크】\n(A) Guardrails는 배포 후 필터.\n(C) Top-K는 무관.\n(D) 암호화도 모델에 내재화된 정보는 못 막음.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon Transcribe — 음성/영상 오디오를 텍스트로 전사 + 타임코드. 자막 생성 표준.\n\n【정답 포인트】\n▸ 자막 = STT → Transcribe.\n\n【오답 체크】\n(A) Comprehend는 NLP 분석.\n(B) Polly는 TTS.\n(D) Translate는 번역.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Clustering — 비지도학습으로 유사 고객 그룹화. 사용자 세그먼트화 표준.\n\n【정답 포인트】\n▸ 라벨 없이 그룹화 = Clustering.\n\n【오답 체크】\n(A) 분류는 사전 정의 라벨.\n(C) 회귀는 숫자.\n(D) 생성은 다른 작업.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Temperature↑ — 확률 분포 평탄화 → 다양·창의적 샘플링.\n\n【정답 포인트】\n▸ 다양성↑ = Temperature↑.\n\n【오답 체크】\n(B) Top K↓는 보수적.\n(C) 길이는 창의성과 무관.\n(D) 프롬프트 짧게는 맥락 부족.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ SageMaker Ground Truth — 라벨링 워크플로 + 사용자 친화 UI + 사람 워커·Mechanical Turk 통합.\n\n【정답 포인트】\n▸ 라벨링 UI = Ground Truth.\n\n【오답 체크】\n(B) Canvas는 노코드 ML.\n(C) Playground는 테스트.\n(D) Agents는 태스크 자동화.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ F1 — 이진 분류 예측 품질의 표준 지표. 실제 라벨 vs 예측 비교.\n\n【정답 포인트】\n▸ 이탈(2진) 예측 정확도 = F1.\n\n【오답 체크】\n(A) RMSE는 회귀.\n(B) ROI는 재무.\n(D) BLEU는 번역.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Knowledge Bases — 관리형 RAG. 문서 인덱싱 후 질의 시 자동 검색·주입. 가장 저비용 사내 지식 활용.\n\n【정답 포인트】\n▸ 회사 맥락 + 비용 효율 = Knowledge Bases.\n\n【오답 체크】\n(B) 모델 교체 도움 안 됨.\n(C) Agents는 태스크.\n(D) 커스텀은 고비용.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ SageMaker 라이프사이클 기능 매핑: 전처리, 학습, 배포, 모니터링 각각 전용 기능 존재.\n\n【정답 포인트】\n▸ 단계별 올바른 기능 선택.\n\n【참고】 HOTSPOT 원문 참고.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Diversity — 성별·연령·지역 등 다양한 하위 집단이 데이터셋에 포함되어야 한다는 품질 속성. 편향 방지 기본.\n\n【정답 포인트】\n▸ 다양 인구통계 포함 = Diversity.\n\n【오답 체크】\n(A) 정확도는 라벨 오류.\n(C) 최신 편향은 시간 집중.\n(D) 신뢰성은 일관성.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ BERTScore — 임베딩 기반 의미 유사도. 정확한 단어 일치(BLEU·ROUGE)와 달리 의미적 유사성 평가 → 창의적 변형된 텍스트 평가에 적합.\n\n【정답 포인트】\n▸ 창의적 변형 + 의미 유사성 = BERTScore.\n\n【오답 체크】\n(A) F1은 분류.\n(C) ROUGE는 n-gram.\n(D) BLEU도 n-gram 기반.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Bedrock Guardrails — 환각 감소를 위한 사실 검증, 금지 주제·유해 필터. 최근에는 Contextual Grounding check도 제공.\n\n【정답 포인트】\n▸ 응답 팩트 검증 = Guardrails.\n\n【오답 체크】\n(A) Config는 AWS 리소스.\n(C) Fraud Detector는 사기.\n(D) Audit Manager는 감사.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ 이미지 생성 = Diffusion (Stable Diffusion, Titan Image). 텍스트 생성 = LLM (Claude, Titan Text).\n\n【정답 포인트】\n▸ 모달리티별 올바른 모델 선택.\n\n【참고】 HOTSPOT 원문 참고.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ SageMaker Model Registry — 모델 버전·승인 단계(Pending/Approved/Rejected)·메타데이터 저장. 모델 관리 표준.\n\n【정답 포인트】\n▸ 모델 버전 관리 = Model Registry.\n\n【오답 체크】\n(A) Audit Manager는 감사.\n(B) Monitor는 드리프트.\n(D) Canvas는 노코드.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Unsupervised Learning (Clustering) — 라벨 없는 데이터 그룹화.\n\n【정답 포인트】\n▸ 라벨 없이 유사성 그룹 = Unsupervised.\n\n【오답 체크】\n(B) 라벨 필요.\n(C) 보상 기반.\n(D) 일부만 라벨 있을 때.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon Translate — 실시간·배치 다국어 번역.\n\n【정답 포인트】\n▸ 다국어 번역 = Translate.\n\n【오답 체크】\n(A) Transcribe는 음성.\n(C) Personalize는 추천.\n(D) Textract는 OCR.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Few-shot Prompting — 공개 문서에서 발췌한 예시(질문-답변 쌍)를 프롬프트에 넣어 응답 품질 향상. 문서 기반 QA 챗봇에 적합.\n\n【정답 포인트】\n▸ 공개 문서 예시 + 챗봇 = Few-shot.\n\n【오답 체크】\n(A) 비표준.\n(B) Zero-shot은 예시 없음.\n(D) Directional은 힌트.",
  ...
  },
  {
    ...
    "answer": "AC",
    "explanation": "【핵심 용어】\n▸ STT(Transcribe) → 번역(Translate) → TTS(Polly)가 자막·더빙 파이프라인 표준.\n\n【정답 포인트】\n▸ 자막 = Transcribe+Translate. 보이스오버 = Polly.\n\n【오답 체크】\n(B) Textract는 문서 OCR.\n(D) Translate는 텍스트만.\n(E) Textract는 음성 생성 불가.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ RAG + Knowledge Bases — 정책 문서 변경 시 KB만 업데이트하면 즉시 반영. fine-tune 없이 최신 데이터 반영.\n\n【정답 포인트】\n▸ 잦은 정책 변경 + near real-time = RAG.\n\n【오답 체크】\n(A) Fine-tune은 갱신 비용.\n(B) FM 선택은 기본.\n(D) Q Business도 가능하나 KB 없이 직접 반영 어려움.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Responsible AI 원칙: Fairness, Explainability, Privacy, Safety, Accountability, Transparency.\n\n【정답 포인트】\n▸ 액션-원칙 정확 매칭.\n\n【참고】 HOTSPOT 원문 참고.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Inference = 학습된 모델이 새 환자 데이터에 예측 생산. 사용 시점 동작.\n\n【정답 포인트】\n▸ 추론 = 예측.\n\n【오답 체크】\n(A) 데이터 수집은 사전 단계.\n(B) 평가는 검증.\n(C) EDA.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS PrivateLink — AWS 서비스로 가는 트래픽을 AWS 프라이빗 네트워크에만 머무르게 함.\n\n【정답 포인트】\n▸ 인터넷 미경유 = PrivateLink.\n\n【오답 체크】\n(B) Q는 AI 어시스턴트.\n(C) CloudFront는 CDN.\n(D) CloudTrail은 감사.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Responsible AI 실천 = 데이터 편향 감사 + 다양성 포함.\n\n【정답 포인트】\n▸ 데이터 편향 제거 = 공정성의 시작.\n\n【오답 체크】\n(B) 복잡도는 편향 해결 아님.\n(C) 비밀 유지는 오히려 반대.\n(D) 정적 셋 모니터는 드리프트 놓침.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS AI 서비스 맵: Kendra(검색), Rekognition(이미지), Polly(TTS), Transcribe(STT), Translate(번역), Comprehend(NLP), Textract(OCR).\n\n【정답 포인트】\n▸ 태스크별 올바른 서비스 매칭.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ SageMaker Canvas — 노코드 ML, 클릭만으로 예측 모델 생성.\n\n【정답 포인트】\n▸ 비개발자 + 예측 = Canvas.\n\n【오답 체크】\n(B) 편향 분석.\n(C) 드리프트.\n(D) 데이터 전처리.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Interpretability — 모델이 어떻게 결정에 이르는지 이해 가능한 정도. Explainability와 유사.\n\n【정답 포인트】\n▸ 예측 이해 = Interpretability.\n\n【오답 체크】\n(B) 학습.\n(C) 상호운용성.\n(D) 성능.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ ML 패러다임 매핑: 분류(라벨), 회귀(숫자), 클러스터링(그룹), 강화학습(보상).\n\n【정답 포인트】\n▸ 태스크별 올바른 기법.\n\n【참고】 HOTSPOT 원문 참고.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ SageMaker 컴포넌트 다수: Experiments, Feature Store, JumpStart, Ground Truth, Pipelines 등.\n\n【정답 포인트】\n▸ 용도별 올바른 선택.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Continued Pre-training — 사내 대규모 비라벨 문서로 도메인 지식 내재화. RAG와 달리 모델 자체에 지식 포함.\n\n【정답 포인트】\n▸ 내부 문서로 모델 적응 = Continued pre-training.\n\n【오답 체크】\n(A) Classification은 분류 태스크.\n(C) Distillation은 모델 압축.\n(D) Regression은 회귀.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Data Drift — 입력 분포 변화로 모델 성능 저하. 해결: 최신 데이터로 재학습.\n\n【정답 포인트】\n▸ 드리프트 완화 = 재학습.\n\n【오답 체크】\n(A) 재시작은 무관.\n(B) 민감도 조정은 임시.\n(D) 실험 추적은 다른 기능.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Explainable AI (XAI) — SHAP·LIME 등으로 '이 결정에 어떤 변수가 얼마나 기여했는지' 투명하게 공개.\n\n【정답 포인트】\n▸ 고객 투명성 = XAI.\n\n【오답 체크】\n(A) 규칙 교체는 과도.\n(C) 기술 설명은 고객에게 부적합.\n(D) 정확도는 투명성과 무관.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Unsupervised Learning — 라벨 없이 패턴 발견. 고객 클러스터링이 대표.\n\n【정답 포인트】\n▸ 라벨 없는 그룹화 = 비지도.\n\n【오답 체크】\n(B) 지도학습 분류.\n(C) 지도학습 회귀.\n(D) 강화학습.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ 비즈니스 KPI 매핑: 매출=전환율·AOV / 참여=체류·세션 / 만족=CSAT·NPS / 리텐션=재방문.\n\n【정답 포인트】\n▸ 목표-지표 올바른 매칭.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ ML 문제별 해법: overfitting→정규화, 데이터↓→증강, 편향→편향 완화.\n\n【정답 포인트】\n▸ 문제-해법 매칭.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AI 용어 구분: Embedding(의미 벡터), Token(입력 단위), Parameter(가중치), Weights(파라미터 집합).\n\n【정답 포인트】\n▸ 정확한 용어 매칭.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Clustering — 라벨 없이 유사성으로 그룹화. 비지도학습 대표.\n\n【정답 포인트】\n▸ 라벨 없음 + 그룹 = 비지도.\n\n【오답 체크】\n(B) 분류.\n(C) 회귀.\n(D) 생성.",
    "en_q": "Which option is an example of unsupervised learning?",
    "en_opts": {
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Data Labeling — 학습용 레코드에 라벨(클래스·값)을 부착. 지도학습 필수 전처리.\n\n【정답 포인트】\n▸ 레코드에 카테고리 부착 = 라벨링.\n\n【오답 체크】\n(A) 인코딩은 수치 변환.\n(C) 정규화는 스케일.\n(D) 밸런싱은 비율 조정.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ 데이터 타입: Tabular(숫자·범주), Text, Audio, Image, Video, Time series.\n\n【정답 포인트】\n▸ 각 유스케이스 데이터 타입 정확 매칭.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Conversion Rate — AI와 상호작용한 고객 중 실제 구매로 이어진 비율. 매출 직접 지표.\n\n【정답 포인트】\n▸ 매출 직접 영향 = 전환율.\n\n【오답 체크】\n(B) 양적 참여.\n(C) 감정은 간접.\n(D) NLU는 기술.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ FM 특성: Context window(입력 크기), Modality(입출력 타입), Latency(속도), Model size(파라미터), Cost.\n\n【정답 포인트】\n▸ 특성별 정확 정의 매칭.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Bedrock Guardrails — 설정 가능한 안전 정책(필터·금지 주제·PII 마스킹). 코드 거의 없이 적용.\n\n【정답 포인트】\n▸ Safeguard 구성 = Guardrails.\n\n【오답 체크】\n(A) Playground는 실험.\n(B) Clarify는 편향 분석.\n(D) JumpStart는 모델 카탈로그.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Bedrock Guardrails Prompt Attack Filter — 인젝션 패턴 자동 탐지·차단. 콘텐츠 필터 + 금지 주제로 다층 방어.\n\n【정답 포인트】\n▸ 인젝션 방어 + 최소 노력 = Guardrails.\n\n【오답 체크】\n(A) Fine-tune은 노력 큼.\n(C) 모델 교체 효과 제한.\n(D) CoT는 추론 개선.",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Bedrock Agents — 다단계 작업 자동 실행: 데이터 조회 → API 호출 → 응답 조합·비교. 복합 워크플로에 특화.\n\n【정답 포인트】\n▸ 다단계·API 호출·비교 = Agents.\n\n【오답 체크】\n(A) Prompt 관리.\n(B) 응답 스트리밍.\n(C) Knowledge Bases는 RAG.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Stable Diffusion on Bedrock — 텍스트 프롬프트로 이미지 생성. 스토리 삽화 생성에 적합.\n\n【정답 포인트】\n▸ 텍스트→이미지 = Stable Diffusion.\n\n【오답 체크】\n(B) Polly는 음성.\n(C) Rekognition은 이미지 분석(생성 X).\n(D) Q Business는 엔터프라이즈 Q&A.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Batch Transform — 대량 데이터 일괄 처리. 월별 리포트에 최적, 비용 저렴.\n\n【정답 포인트】\n▸ 월별 리포트 = Batch.\n\n【오답 체크】\n(A) Real-time은 실시간.\n(C) Serverless는 간헐.\n(D) Async는 단건.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ ML Lifecycle 표준 순서 이해가 핵심. 각 단계 순서 암기.\n\n【정답 포인트】\n▸ 표준 라이프사이클 순서 숙지.\n\n【참고】 HOTSPOT 원문 참고.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ 프롬프트 기법: Zero-shot, One-shot, Few-shot, CoT, Least-to-most, Prompt chaining, ReAct.\n\n【정답 포인트】\n▸ 기법-설명 정확 매칭.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Supervised Learning — 라벨(심장병 여부) 있는 데이터로 분류·예측 학습.\n\n【정답 포인트】\n▸ 라벨 있는 분류 = 지도학습.\n\n【오답 체크】\n(A) 비지도는 라벨 없음.\n(C) 강화는 보상.\n(D) Semi-supervised는 일부 라벨.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ 문서 자동화 파이프라인: 추출 → AI 처리 → 저장. Textract + Bedrock 조합 표준.\n\n【정답 포인트】\n▸ 올바른 단계 순서.\n\n【참고】 HOTSPOT 원문 참고.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Data Retention Policy — 데이터를 얼마나 보관, 언제 삭제할지 규정. GDPR 등 규제 핵심.\n\n【정답 포인트】\n▸ 저장·삭제 가이드 = 보존 정책.\n\n【오답 체크】\n(A) 비식별화.\n(B) 품질 기준.\n(D) 로그 저장.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon Q Developer — IDE 내 통합 AI. 선택한 코드에 대한 단위 테스트·문서 자동 생성.\n\n【정답 포인트】\n▸ IDE + 테스트·문서 자동화 = Q Developer.\n\n【오답 체크】\n(A) 제3자 업로드는 보안 위험.\n(B) 직접 앱 개발은 노력 큼.\n(D) 수동.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Logistic Regression — 각 피처 계수 해석 가능. 대출·의료 등 규제 산업에서 해석 가능성 요구 시 표준.\n\n【정답 포인트】\n▸ 해석 가능 분류 = Logistic regression.\n\n【오답 체크】\n(A) 딥러닝은 블랙박스.\n(C) K-means는 비지도.\n(D) RCF는 이상 탐지.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Data Preprocessing — 원시 데이터를 학습 가능 형태로 정제(필터링·클리닝·포맷).\n\n【정답 포인트】\n▸ 데이터 필터링 = 전처리.\n\n【오답 체크】\n(A) 수집은 완료.\n(C) 피처 엔지니어링은 새 피처 생성.\n(D) 학습은 이후.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Continued Pre-training — 비라벨 도메인 텍스트로 사전학습 연장. 새 도메인·용어 주입.\n\n【정답 포인트】\n▸ 라벨 없음 + 도메인 지식 = Continued pre-training.\n\n【오답 체크】\n(A) Full은 과도.\n(B) Supervised는 라벨 필요.\n(D) RAG는 학습 아님.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ 커스터마이즈 복잡도 증가 순: Prompt → RAG → Fine-tuning → Continued pre-training.\n\n【정답 포인트】\n▸ 개발 노력 순서 이해.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "AE",
    "explanation": "【핵심 용어】\n▸ Q Business 보안 = KMS 암호화 + IAM 인증. 암호화(저장) + 신원 확인(접근) 양축.\n\n【정답 포인트】\n▸ 데이터 보안 = KMS + IAM.\n\n【오답 체크】\n(B) 크로스 계정은 확장.\n(C) Inspector는 보안 스캔.\n(D) 퍼블릭은 위험.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ CloudWatch Metrics + Alarms — 서비스 사용 메트릭을 기준 알림. 미사용 감지에 적합.\n\n【정답 포인트】\n▸ 사용량 기반 알림 = CloudWatch.\n\n【오답 체크】\n(A) Trusted Advisor는 일반 권고.\n(C) CloudTrail은 API 감사.\n(D) Config는 구성 이력.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon Nova Pro — 고성능 멀티모달 FM. 텍스트·이미지·비디오 이해 + fine-tune 지원.\n\n【정답 포인트】\n▸ 멀티모달 이해 + fine-tune = Nova Pro.\n\n【오답 체크】\n(B) 임베딩 전용.\n(C) 텍스트 전용.\n(D) 멀티모달이지만 이해 제한.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Bedrock Batch Inference — JSONL로 대량 요청 일괄 제출 → 비동기 결과. 실시간 불필요 + 저비용.\n\n【정답 포인트】\n▸ 대량 + 즉시성 X = Batch inference.\n\n【오답 체크】\n(A) 실시간은 비용↑.\n(C) 에이전트는 과도.\n(D) Lambda 수동은 노력 큼.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ ML 태스크 매핑: 이진/다중 분류, 회귀(숫자), 클러스터링(그룹).\n\n【정답 포인트】\n▸ 유스케이스에 맞는 접근.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Fine-tuning — 라벨된 (입력, 출력) 쌍으로 태스크 전용 성능 향상. 이미지 분류·정보 추출.\n\n【정답 포인트】\n▸ 라벨 데이터 + 태스크 특화 = Fine-tuning.\n\n【오답 체크】\n(A) 비라벨 대규모.\n(B) Agent는 오케스트레이션.\n(D) Prompt는 학습 아님.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Bedrock Agents — 사용자 요청 해석 → 백엔드 API 호출(예약 생성) → 결과 응답. 액션 자동화의 핵심.\n\n【정답 포인트】\n▸ 요청 처리 + API 호출 = Agents.\n\n【오답 체크】\n(B) 라우팅.\n(C) 지식 검색.\n(D) 안전 필터.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Q Developer — IDE 내 테스트 코드 자동 생성. 최소 노력.\n\n【정답 포인트】\n▸ 테스트 코드 생성 = Q Developer.\n\n【오답 체크】\n(A) Q Business는 사내 질의.\n(B) Agents는 워크플로.\n(D) Clarify는 편향.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ FM 커스터마이즈 3축 요약: 외부 지식(RAG), 태스크 특화(Fine-tuning), 도메인 적응(Continued pre-training).\n\n【정답 포인트】\n▸ 설명-방법 정확 매칭.\n\n【참고】 HOTSPOT 원문.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Bedrock — 관리형 FM 플랫폼. API 몇 줄로 FM 호출. 최소 개발 노력.\n\n【정답 포인트】\n▸ 최소 노력 FM = Bedrock.\n\n【오답 체크】\n(B) SageMaker는 ML 개발 전반.\n(C) PartyRock은 실험.\n(D) Q Developer는 IDE 도우미.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Completeness — LLM-as-a-judge 내장 지표. 응답이 질문의 모든 측면을 다루었는지 평가.\n\n【정답 포인트】\n▸ 모든 부분 커버 = Completeness.\n\n【오답 체크】\n(A) ROUGE는 요약.\n(C) 지시 준수.\n(D) 거부율.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ CloudTrail — 모든 AWS API 호출을 감사 로그로 기록. 누가·언제·무엇을.\n\n【정답 포인트】\n▸ 액션 감사 = CloudTrail.\n\n【오답 체크】\n(B) Config는 구성.\n(C) Audit Manager는 컴플라이언스.\n(D) Trusted Advisor는 권고.",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Multimodal LLM — 텍스트·이미지 입력을 이해하고 텍스트 응답. 질문 답변 + 설명 생성.\n\n【정답 포인트】\n▸ 텍스트+이미지 이해+답변 = Multimodal LLM.\n\n【오답 체크】\n(A) CV는 이미지만.\n(C) Diffusion은 이미지 생성.\n(D) TTS는 음성 출력.",
  ...
  {
    "id": 382,
    "question": "Continued pre-training이란?",
    "options": {
      "A": "라벨 데이터로 태스크 특화 fine-tune",
      "B": "비라벨 데이터로 사전학습 모델에 도메인 지식 주입",
      "C": "특정 데이터셋으로 처음부터 학습",
      "D": "사전학습 모델을 테스트셋으로 평가"
    },
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Continued Pre-training = 사전학습 모델에 비라벨 데이터로 도메인 특화 학습 이어감.\n\n【정답 포인트】\n▸ 비라벨 + 도메인 적응 = Continued pre-training.\n\n【오답 체크】\n(A) Fine-tuning.\n(C) From-scratch.\n(D) Evaluation.",
    "en_q": "What is continues pre-training?",
    "en_opts": {
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Feature Engineering — 원시 데이터에서 예측에 유용한 피처를 만들거나 선택. 모델 정확도의 결정적 요소.\n\n【정답 포인트】\n▸ 피처 생성·선택 = Feature engineering 정의.\n\n【오답 체크】\n(A) EDA.\n(B) 튜닝.\n(D) 데이터 수집.",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AI Governance Cycle: 리스크 식별 → 정책 → 실행 → 모니터 → 반복 개선.\n\n【정답 포인트】\n▸ 거버넌스 순서 이해.\n\n【참고】 HOTSPOT 원문.",
