window.AIP_QUESTIONS = [
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS API Gateway, AWS Lambda, AWS Step Functions, Amazon Bedrock, Amazon DynamoDB, Amazon Kendra, Amazon SageMaker, Retrieval Augmented Generation\n\n【정답 포인트】\n▸ 정답: D\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(D) Amazon Bedrock 에이전트를 주문 관리 API와 통합하는 액션 그룹과 함께 사용합니다. Retrieval Augmentation Gen...\n\n【오답 체크】\n(A) 각 제품 카테고리에 대해 미세 조정된 Amazon Bedrock Anthropic Claude 모델을 배포합니다. 각 모델을 ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(B) 모든 제품 문서에 대해 지속적인 사전 학습을 사용하는 사용자 정의 모델을 생성합니다. 모델을 주문 관리 API에 연결하는 AW...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) Amazon SageMaker AI를 컨테이너와 함께 사용하여 모델을 배포합니다. Amazon Kendra를 사용하여 제품 문...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Lambda, AWS Step Functions, Amazon Bedrock, Amazon DynamoDB, Amazon EventBridge, Amazon S3, ReAct Pattern\n\n【정답 포인트】\n▸ 정답: B\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(B) Amazon Bedrock 통합을 구성하여 대용량 출력을 위한 입력 매개변수에서 S3 버킷 URI를 사용합니다. ResultPath 필드와 Re...\n\n【오답 체크】\n(A) 중간 출력을 Amazon DynamoDB에 저장합니다. 상태 간에만 참조를 전달합니다. 각 에이전트 처리 단계에 필요할 때 D...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) 각 에이전트 상태 이전에 출력을 256KB 미만으로 압축하도록 AWS Lambda 함수를 사용합니다. 각 에이전트 작업을 구성...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) 각 에이전트의 처리를 처리하도록 별도의 Step Functions 상태 머신을 구성합니다. 상태 머신 간 실행 흐름을 조정하도...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS API Gateway, AWS Lambda, Amazon Bedrock, Amazon OpenSearch Service, PostgreSQL, pgvector\n\n【정답 포인트】\n▸ 정답: B\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(B) 식당 데이터를 Amazon OpenSearch Service로 마이그레이션합니다. Amazon Bedrock에서 foundation model(...\n\n【오답 체크】\n(A) 식당 데이터를 Amazon OpenSearch Service로 마이그레이션합니다. 사용자 정의 분석기 및 관련성 튜닝을 사용하...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) PostgreSQL에 식당 데이터를 유지하고 pgvector 확장을 구현합니다. Amazon Bedrock에서 foundati...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) 식당 데이터를 사용자 정의 수집 파이프라인을 사용하여 Amazon Bedrock knowledge base로 마이그레이션합니다...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon Bedrock, Amazon CloudWatch, Amazon Comprehend\n\n【정답 포인트】\n▸ 정답: B\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(B) 코드 리포지토리에서 프롬프트의 버전 관리를 구현하고 복잡한 임상 문서 및 정량화 가능한 평가 메트릭을 포함하는 테스트 스위트를 사용합니다. 자동...\n\n【오답 체크】\n(A) Amazon Bedrock의 Prompt management를 사용하여 여러 프롬프트 변형을 생성합니다. 단순한 임상 문서로 ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) 각 새로운 프롬프트 버전을 별도의 Amazon Bedrock API 엔드포인트에 배포합니다. 엔드포인트 간에 프로덕션 트래픽을...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) Amazon Bedrock Flows에서 사용자 정의 프롬프트 평가 흐름을 생성합니다. Amazon Comprehend Med...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "AB",
    "explanation": "【핵심 용어】\n▸ Amazon Bedrock, Retrieval Augmented Generation\n\n【정답 포인트】\n▸ 정답: AB\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(A) 모델이 각 요약을 생성하기 전에 단계별 추론과 명시적 팩트 검증을 요구하는 제로샷 사고 연쇄(CoT) 지시를 구현합니다....\n▸ \n(B) Amazon Bedrock knowledge base와 함께 Retrieval Augmented Generation(RAG)을 사용합니다. 의미...\n\n【오답 체크】\n(C) 환각된 콘텐츠와 연결된 패턴과 일치하는 생성된 출력을 차단하도록 Amazon Bedrock Guardrails을 구성합니다....\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) Amazon Bedrock의 온도 매개변수를 증가시킵니다....\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(E) Amazon Bedrock 모델에 한 번에 전체 문서를 요약하도록 프롬프트합니다....\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon Bedrock, Amazon CloudWatch, Amazon OpenSearch Service\n\n【정답 포인트】\n▸ 정답: C\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(C) 애플리케이션 리소스에 대해 Amazon CloudWatch Application Insights를 활성화합니다. CloudWatch 임베드된 메...\n\n【오답 체크】\n(A) 애플리케이션 인프라에 대해 Amazon CloudWatch Container Insights를 구성합니다. 지연 시간 임계값에...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(B) AWS X-Ray를 구현하여 애플리케이션 구성 요소를 통해 요청을 추적합니다. 오류 패턴 감지를 위해 CloudWatch Lo...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) 관찰성 플러그인이 있는 Amazon OpenSearch Service를 사용합니다. Amazon Kinesis를 사용하여 모델...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ AWS Lambda, Amazon Bedrock\n\n【정답 포인트】\n▸ 정답: C\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(C) breakpoint percentile 임계값을 95%로 설정하고 버퍼 크기를 3개 문장으로 사용한 의미론적 청킹을 사용합니다. Amazon B...\n\n【오답 체크】\n(A) 4,000개 토큰의 고정 크기 청킹을 20% 겹침으로 구성합니다. 애플리케이션 레벨 로직을 사용하여 여러 청크를 순차적으로 연...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(B) 부모 청크가 8,000 토큰이고 자식 청크가 2,000 토큰인 계층적 청킹을 사용합니다. Amazon Bedrock Knowl...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) 문서 토큰 수를 분석하는 FM의 토크나이저를 사용하는 사전 처리 AWS Lambda 함수를 생성합니다. Lambda 함수를 구...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "AC",
    "explanation": "【핵심 용어】\n▸ AWS Lambda, Amazon Bedrock, Amazon CloudWatch, Amazon S3, Amazon SageMaker\n\n【정답 포인트】\n▸ 정답: AC\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(A) 데이터세트를 Amazon S3 버킷으로 가져옵니다. 평가 작업이 데이터세트에 액세스할 수 있도록 적절한 IAM 권한 및 크로스 오리진 리소스 공...\n▸ \n(C) Amazon Bedrock 콘솔에서 acl.json이라는 JSON 파일을 생성하여 각 부서 폴더에 배치합니다. 각 파일에서 해당 부서의 데이터에...\n\n【오답 체크】\n(B) 데이터세트를 Amazon S3 버킷으로 가져옵니다. 평가 작업이 데이터세트에 액세스할 수 있도록 적절한 IAM 권한 및 VPC...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) Amazon SageMaker Clarify를 일정에 따라 사용하여 모델 평가 작업을 생성합니다. 오픈 소스 프레임워크를 사용...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(E) Amazon SageMaker AI 노트북 작업을 일정에 따라 fmevals 또는 ragas 프레임워크를 사용하여 실행합니다....\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Lambda, AWS Step Functions, Amazon Bedrock, Amazon DynamoDB, Amazon EventBridge\n\n【정답 포인트】\n▸ 정답: B\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(B) waitForTaskToken API를 사용하는 인간 승인 단계가 있는 AWS Step Functions 워크플로우를 생성합니다. 인간 기술자가...\n\n【오답 체크】\n(A) AWS Lambda 함수 및 Amazon SQS 큐를 사용하여 인간 검토를 위한 사용자 정의 승인 워크플로우를 생성합니다. 모...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) 인간 승인 단계가 있는 AWS Glue 워크플로우를 생성합니다. 인간 기술자 검토 후, SendTaskSuccess API를 ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) AI 권장 사항을 인간 기술자에게 검토하도록 라우팅하기 위해 사용자 정의 이벤트 패턴을 사용하여 Amazon EventBrid...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "ABD",
    "explanation": "【핵심 용어】\n▸ AWS Lambda, AWS Step Functions, Amazon Bedrock, Amazon Kendra, Amazon OpenSearch Service, Amazon S3, Amazon SageMaker\n\n【정답 포인트】\n▸ 정답: ABD\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(A) 스캔한 문서에서 관련 데이터를 추출하기 위해 Amazon Textract와 Amazon Augmented AI(Amazon A2I)를 동일한 리...\n▸ \n(B) 제출된 문서에서 PII를 감지하고 마스킹하기 위해 AWS Lambda 함수를 사용합니다. 모델 출력의 부적절하거나 승인되지 않은 콘텐츠를 방지하...\n▸ \n(D) 업로드된 문서를 Amazon S3에 저장하고 객체 메타데이터를 적용합니다. IAM 정책을 구성하여 각 신청자와 동일한 리전 내에 원본 문서를 저...\n\n【오답 체크】\n(C) 업로드된 문서에서 필드 레벨 값을 의미론적으로 추출하기 위해 Amazon Kendra와 Amazon OpenSearch Ser...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(E) AWS Glue Data Quality를 사용하여 구조화된 문서 데이터를 검증합니다. AWS Step Functions를 사용...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(F) Amazon Bedrock이 수행한 모델 채점 결정을 기반으로 공정성 및 편향 보고서를 생성하기 위해 Amazon SageMa...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon S3\n\n【정답 포인트】\n▸ 정답: B\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(B) S3 버킷의 최상위 수준에서 acl.json이라는 단일 JSON 파일을 생성합니다. 각 부서의 S3 접두사를 해당하는 IAM Identity C...\n\n【오답 체크】\n(A) 각 부서 폴더에서 acl.json이라는 JSON 파일을 생성합니다. 각 파일에서 해당 부서의 데이터에 액세스해야 하는 IAM ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) 각 IAM Identity Center 그룹에 대해 S3 버킷의 모든 접두사에 대한 액세스를 거부하는 별도의 권한 집합을 생성...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) S3 버킷의 최상위 수준에서 metadata.json이라는 메타데이터 파일을 생성합니다. 파일에 각 부서의 접두사의 S3 경로...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon Bedrock, Amazon Comprehend, Amazon Kendra\n\n【정답 포인트】\n▸ 정답: B\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(B) Amazon Bedrock knowledge base를 승인된 임상 소스 문서에 연결하고 배포합니다. Amazon Bedrock Retrieve...\n\n【오답 체크】\n(A) Amazon Bedrock을 Amazon Kendra와 통합하여 승인된 문서를 검색합니다. 생성된 응답을 소스 문서와 비교하고...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) Amazon Bedrock과 Amazon Comprehend Medical을 사용하여 의료 엔티티를 추출합니다. 의료 용어 데...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) Amazon Bedrock knowledge base와 Retrieve API 호출 및 InvokeModel API 호출을 사...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS API Gateway, AWS Lambda, Amazon Bedrock, Amazon Comprehend, Amazon DynamoDB\n\n【정답 포인트】\n▸ 정답: B\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(B) 부분 결과가 활성화된 Amazon Transcribe 스트리밍을 사용하여 고객이 말을 마치기 전에 전사된 텍스트 조각을 전달합니다. 텍스트 조각...\n\n【오답 체크】\n(A) Amazon Transcribe 스트리밍 API를 사용하여 통화를 전사합니다. 텍스트를 Amazon Comprehend로 전달...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) Amazon Transcribe 일괄 처리를 사용하여 통화를 텍스트로 변환합니다. 완전한 전사본을 ConverseStream ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) Amazon Transcribe 스트리밍 API를 AWS Lambda 함수와 사용하여 각 오디오 세그먼트를 전사합니다. Lam...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS API Gateway, AWS Lambda, AWS Step Functions, Amazon Bedrock, Amazon CloudWatch, Amazon Comprehend, Amazon S3, Amazon SageMaker\n\n【정답 포인트】\n▸ 정답: D\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(D) 내장 Amazon Bedrock guardrails를 사용하여 콘텐츠를 필터링하는 AWS Step Functions 워크플로우를 생성합니다. A...\n\n【오답 체크】\n(A) Enhanced Monitoring 도구를 활성화합니다. Amazon CloudWatch 알람을 사용하여 플랫폼 트래픽을 필터...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(B) Amazon API Gateway HTTP API를 요청 검증 템플릿과 함께 사용하여 Amazon S3에 업로드된 콘텐츠를 저...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) 인증 전 AWS Lambda 함수를 실행하는 Amazon Cognito 사용자 풀을 생성합니다. Amazon Textract를...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS Services\n\n【정답 포인트】\n▸ 정답: D\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(D) Amazon Q Developer 커스터마이제이션을 생성하고 승인된 데이터 소스를 포함합니다. 개발자들이 이 커스터마이제이션을 사용하여 애플리케...\n\n【오답 체크】\n(A) 승인된 내부 라이브러리, 알고리즘, 코드 샘플을 모두 포함하는 Git 리포지토리를 생성합니다. 이 Git 리포지토리를 워크스페...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(B) 프로젝트 루트 폴더에 .amazonq/rules라는 폴더를 생성합니다. 승인된 내부 라이브러리, 알고리즘, 코드 샘플을 폴더에...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) 애플리케이션 프로젝트에 rules라는 폴더를 생성합니다. Amazon Q Developer가 참조할 수 있도록 폴더에 지침과 ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS Lambda, Amazon Bedrock, Amazon DynamoDB\n\n【정답 포인트】\n▸ 정답: A\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(A) 성능 구성의 지연시간 매개변수를 최적화로 설정하여 지연시간 최적화된 추론을 구성합니다. 반복되는 문의를 처리하기 위해 프롬프트 캐싱을 사용합니다...\n\n【오답 체크】\n(B) 피크 트래픽을 처리할 수 있도록 크기 조정된 프로비저닝된 처리량 및 모델 유닛(MU)을 구매합니다. 반복 문의를 캐시하기 위해...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) Amazon Bedrock Agents 및 사용자 정의 지식 기반을 사용하여 고객 문의를 전처리합니다. 트래픽을 분산하기 위해...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) AWS Lambda 함수를 사용하여 사용자 정의 프롬프트 라우팅 메커니즘으로 요청을 전처리합니다. 자주 묻는 질문을 처리하기 ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon Bedrock, Amazon DynamoDB, Amazon OpenSearch Service, Amazon S3, Retrieval Augmented Generation\n\n【정답 포인트】\n▸ 정답: C\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(C) 청킹 전략을 고정 토큰 제한 대신 완전한 법적 주장, 조항 또는 섹션과 같은 의미론적 경계를 사용하도록 업데이트합니다. 새로운 청크 구조에 맞추...\n\n【오답 체크】\n(A) 기존 청킹 또는 전처리 전략을 변경하지 않고 임베딩 벡터 차원을 768에서 4,096으로 증가시킵니다....\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(B) 동적 검색을 사전 작성된 정적 요약으로 바꿉니다. Amazon S3에 요약을 저장하고 Amazon CloudFront를 사용하...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) OpenSearch Service에서 Amazon DynamoDB로 마이그레이션합니다. 법적 개념의 빠른 조회를 위해 키워드 ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS API Gateway, AWS Lambda, AWS Step Functions, Amazon Bedrock, Amazon DynamoDB, Amazon S3\n\n【정답 포인트】\n▸ 정답: B\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(B) AWS Step Functions Standard 워크플로우를 사용하여 명확화 워크플로우를 조율합니다. 워크플로우를 관리하기 위해 콜백 대기 패...\n\n【오답 체크】\n(A) AWS Step Functions Express 워크플로우를 사용하여 대화 흐름을 조율합니다. 명확화 로직을 실행하기 위해 A...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) Amazon API Gateway REST API를 배포하여 사용자 요청을 AWS Lambda 함수로 라우팅하고 대화 문맥을 ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) AWS Lambda 함수를 사용하여 Amazon Bedrock 추론 API를 호출합니다. 명확화 단계를 조율하기 위해 Amaz...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Lambda, AWS Step Functions, Amazon Bedrock, Amazon CloudWatch, Amazon Comprehend, Amazon S3, Amazon SageMaker\n\n【정답 포인트】\n▸ 정답: B\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(B) AWS Glue 크롤러를 설정하여 데이터 소스를 카탈로그합니다. 사용자 정의 변환 스크립트를 실행하기 위해 AWS Glue ETL 작업을 생성합...\n\n【오답 체크】\n(A) Amazon SageMaker Data Wrangler를 사용하여 데이터 흐름을 생성합니다. Amazon CloudWatch ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) Amazon Comprehend를 사용하여 엔티티를 추출합니다. 텍스트를 청킹하기 위해 AWS Lambda 함수를 생성합니다....\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) 데이터 전처리 작업을 조율하기 위해 AWS Step Functions 워크플로우를 생성합니다. Amazon EC2 인스턴스에서...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon Bedrock, Amazon OpenSearch Service, Amazon S3, Retrieval Augmented Generation\n\n【정답 포인트】\n▸ 정답: C\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(C) Amazon Bedrock 지식 기반 내에서 S3 객체 메타데이터를 인덱싱하여 메타데이터 인식 필터링을 활성화합니다....\n\n【오답 체크】\n(A) 벡터 유사도 개선을 위해 긴급 뉴스 콘텐츠에 특별히 훈련된 도메인 적응 모델을 사용하여 임베딩을 향상시킵니다....\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(B) Amazon OpenSearch Service로 마이그레이션합니다. 벡터 필드와 메타데이터 필터를 사용하여 결과 검색 범위를 ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) Amazon Q Business 인덱스로 마이그레이션하여 검색 중 구조화된 메타데이터 필터링과 문서 분류를 수행합니다....\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon Bedrock, PostgreSQL, Retrieval Augmented Generation\n\n【정답 포인트】\n▸ 정답: A\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(A) Amazon MemoryDB 클러스터를 시작하고 Flat 알고리즘을 사용하여 인덱스를 구성합니다. 성능 메트릭을 기반으로 수평 확장 정책을 구성...\n\n【오답 체크】\n(B) Amazon MemoryDB 클러스터를 시작하고 계층적 탐색 가능한 작은 세계(HNSW) 알고리즘을 사용하여 인덱스를 구성합니...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) Amazon Aurora PostgreSQL 클러스터를 시작하고 Inverted File with Flat Compressio...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) Inverted File with Flat Compression(IVFFlat) 인덱스와 높은 probe 값을 가진 Amazo...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS Lambda, AWS Step Functions, Amazon Bedrock, Amazon Comprehend, Amazon OpenSearch Service, Amazon S3, Amazon SageMaker, PostgreSQL, Retrieval Augmented Generation, pgvector\n\n【정답 포인트】\n▸ 정답: D\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(D) AWS Step Functions를 사용하여 Amazon Comprehend로 PII를 감지하고 Amazon Bedrock으로 임베딩을 생성하는...\n\n【오답 체크】\n(A) AWS Lambda와 Amazon Comprehend를 사용하여 파일을 병렬로 처리하고 PII를 제거하며 Amazon Bedr...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(B) AWS Glue ETL 작업을 생성하여 데이터에 대해 PII 감지 스크립트를 실행합니다. Amazon SageMaker Pro...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) Apache Spark와 사용자 정의 함수(UDF)를 실행하는 Amazon EMR 클러스터를 배포하여 Amazon Compre...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ AWS API Gateway, AWS Lambda, Amazon CloudWatch, Amazon DynamoDB, Amazon EventBridge\n\n【정답 포인트】\n▸ 정답: C\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(C) AWS AppConfig를 사용하여 모델 구성을 관리합니다. A/B 테스트를 수행하기 위해 기능 플래그를 사용합니다. 모델 매개변수에 대해 JS...\n\n【오답 체크】\n(A) AWS Systems Manager Parameter Store에 각 구성에 대한 매개변수를 생성합니다. Lambda 함수를 ...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(B) Amazon DynamoDB 테이블에 모델 구성을 저장합니다. 고객 등급에 따라 구성을 검색하는 접근 패턴을 최적화합니다. L...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) 모델 구성을 저장하기 위해 Amazon ElastiCache(Redis OSS) 클러스터를 생성합니다. 짧은 TTL 값을 설정...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Lambda, Amazon Bedrock, Amazon S3\n\n【정답 포인트】\n▸ 정답: B\n▸ 요구사항 충족: 최소 운영 오버헤드, 확장성, 성능 기준\n▸ 솔루션들:\n▸ \n(B) 토큰 배칭을 구현하여 API 오버헤드를 줄입니다. 교차 지역 추론 프로필을 사용하여 사용 가능한 지역 전체에 트래픽을 자동으로 분산합니다....\n\n【오답 체크】\n(A) 단일 지역에서 프로비저닝된 처리량과 충분한 모델 유닛(MU)을 구매합니다. 실패한 요청을 지수 백오프로 다시 시도하도록 애플리...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(C) 각 지역에서 AWS Lambda 함수를 자동 확장하도록 설정합니다. 클라이언트 측 라운드로빈 요청 분산을 구현합니다. 백업으로...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n(D) 모든 요청에 대해 Amazon S3 버킷을 사용하여 배치 추론을 구현합니다. 여러 지역에서 Amazon SQS를 사용하여 비동...\n▸ 제한사항: 구현 복잡도, 운영 오버헤드, 또는 요구사항 부분 충족\n\n【시험 포인트】\n▸ 패턴: AWS AI 서비스 통합 및 확장 가능 아키텍처 설계\n▸ 핵심: 요구사항 대비 최소 운영 오버헤드 솔루션 선택\n▸ 검증: 성능, 비용, 보안, 관찰성 측면의 종합 검토\n▸ 주의: 각 서비스의 기능, 제약, 통합 방식 정확히 이해",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ MCP(Model Context Protocol) — AI 에이전트와 서버 간 통신 표준\n▸ 전송 메커니즘 — STDIO(동기), HTTP(비동기), Streamable\n▸ 인증 방식 — IAM, OAuth, API 게이트웨이, Cognito\n\n【정답 포인트】\n▸ API Gateway HTTP API로 Lambda 앞에 인증 계층 생성\n▸ Cognito OAuth 2.1로 권한 있는 사용자만 접근\n▸ Streamable HTTP 전송으로 안전한 비동기 통신\n▸ MCP 클라이언트가 HTTP API를 통해 안전하게 호출\n\n【오답 체크】\n(A) 비동기 호출만으로는 인증/인가 메커니즘 부족\n(B) STDIO는 프로세스 간 로컬 통신이므로 원격 접근 불가\n(D) Lambda 레이어 + 환경변수는 권한 관리 미흡\n\n【시험 포인트】\n▸ MCP 전송 메커니즘의 특성(STDIO vs HTTP 차이)\n▸ API Gateway 기반 보안 아키텍처\n▸ OAuth 인증과 IAM 권한의 계층적 제어",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Step Functions — 워크플로우 조율 및 상태 관리\n▸ 에이전트 순차 실행 — 검색→추천→주문 순서\n▸ 복원력 패턴 — 재시도/catch로 우아한 성능 저하(Graceful Degradation)\n\n【정답 포인트】\n▸ Step Functions 상태 머신으로 3개 에이전트 순차 실행\n▸ 각 작업 단계에 재시도(Retry) 및 catch 브랜치 설정\n▸ catch 브랜치로 서비스 실패 시 부분 응답 제공\n▸ Lambda 함수로 보상 계산을 마지막 단계에 통합\n\n【오답 체크】\n(A) Lambda 조율 + API Gateway는 통합 워크플로우 추상화 부족\n(C) 에이전트별 폴백은 에이전트 자체만 보호, 통합 흐름 제어 미흡\n(D) Step Functions 필요한데 단일 작업만으로는 순차 실행 불가\n\n【시험 포인트】\n▸ Step Functions의 재시도/catch 브랜치 메커니즘\n▸ 우아한 성능 저하 개념과 구현\n▸ 에이전트 기반 워크플로우 조율의 모범사례",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Bedrock Flows vs Step Functions — 플로우 기반 vs 상태 머신\n▸ S3 통합 — GetObject/PutObject 작업\n▸ 데이터 파싱 — Pass 단계로 표현식 처리\n\n【정답 포인트】\n▸ Step Functions Express 사용(저지연 워크플로우)\n▸ S3 GetObject로 원본 통신 검색\n▸ Pass 단계로 통신에서 부분만 파싱/추출\n▸ InvokeModel로 Bedrock 모델 호출\n▸ S3 PutObject로 모델 응답 저장\n\n【오답 체크】\n(A) Bedrock Flows는 플로우 기반이지만 S3 액션 노드 구성이 복잡\n(C) 에이전트는 오버헤드이며 문서 파싱 전담 도구 아님\n(D) 에이전트 + 3개 Lambda는 불필요하게 복잡하고 유지보수 어려움\n\n【시험 포인트】\n▸ Express(저지연) vs Standard 상태 머신 선택\n▸ S3 GetObject/PutObject 통합\n▸ Pass 단계를 통한 데이터 변환",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ 자동 평가 — 판사 모델(Judge Model)로 응답 채점\n▸ Guardrails — 규정 준수 검증(정책 강제)\n▸ 인적 검토 — Amazon A2I로 중요 상호작용 심사\n\n【정답 포인트】\n▸ Claude Sonnet을 판사 모델로 정확성/적절성 평가\n▸ Bedrock Guardrails로 금융 규정 준수 강제\n▸ A2I(Augmented AI)로 플래그된 중요 상호작용만 인적 검토\n▸ 3계층 방어: 자동 평가 → Guardrails → 인적 검토\n\n【오답 체크】\n(A) 수동 검토는 확장성 없음, 1000건 응답 검토 불가\n(C) Lex + Lambda는 평가 시스템이 아닌 챗봇\n(D) CloudWatch는 모니터링일 뿐 실제 평가/검증 기능 없음\n\n【시험 포인트】\n▸ 자동 평가 시스템의 3계층 설계\n▸ 판사 모델(Judge Model) 개념\n▸ Amazon A2I를 활용한 인적 검토 통합",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ 감독 에이전트 — 의도 분류 및 라우팅\n▸ 협력 에이전트 — 부서별 도메인 특화\n▸ 지식 기반 격리 — IAM 제어 + RAG\n\n【정답 포인트】\n▸ 감독 에이전트로 자연어 의도 분류(임상→보험→예약→청구)\n▸ 전문화된 협력 에이전트로 쿼리 라우팅\n▸ 부서별 지식 기반 격리로 액세스 제어\n▸ IAM 필터링 + RAG로 도메인 특화 응답\n\n【오답 체크】\n(B) 부서별 감독 에이전트는 중복, 수동 인계는 확장성 없음\n(C) 단일 범용 에이전트는 도메인 특화 어려움, 액션 그룹 관리 복잡\n(D) 동일 지식 기반은 부서별 격리 불가, 응답 품질 저하\n\n【시험 포인트】\n▸ 감독/협력 에이전트 패턴\n▸ 마이크로서비스 아키텍처의 도메인 분리\n▸ 부서별 격리와 확장성 동시 달성",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ AWS CDK — Infrastructure as Code(코드로 인프라 정의)\n▸ CodePipeline — CI/CD 자동화\n▸ FoundationModel API — 런타임에 모델 ID 동적 참조\n\n【정답 포인트】\n▸ 단일 CDK 애플리케이션으로 코드 재사용\n▸ fromFoundationModelId()로 모델 ID를 파라미터로 참조\n▸ 단일 CodePipeline으로 개발/프로덕션 환경 배포\n▸ 환경별 설정만 변경하면 모델 전환 가능(코드 수정 불필요)\n\n【오답 체크】\n(A) 파이프라인 여러 개는 복잡하고 중복 코드 발생\n(B) 환경별 CDK는 코드 중복, 유지보수 어려움\n(D) 프로덕션만 IaC는 일관성 없음, 개발 환경도 코드로 관리해야 함\n\n【시험 포인트】\n▸ CDK의 단일 정의 원칙\n▸ CodePipeline 다단계 배포\n▸ 런타임 파라미터를 통한 동적 모델 선택",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ 멀티 계정 구조 — 호텔별 완전 격리\n▸ 직접 데이터 수집 — 실시간 PMS 동기화\n▸ 정기 동기화 — 덜 중요한 정보는 배치 처리\n\n【정답 포인트】\n▸ 호텔별 지식 기반으로 액세스 제어 구현\n▸ 직접 데이터 수집으로 실시간 객실 가용성 제공\n▸ 정기 동기화로 덜 중요한 정보는 배치 처리\n▸ 멀티 계정으로 완전 데이터 격리, 피크 시간 성능 안정\n\n【오답 체크】\n(A) 단일 지식 기반은 호텔별 격리 실패, 필터는 충분하지 않음\n(B) 중앙화된 지식 기반은 호텔별 격리 불가, 성능 저하\n(D) 중앙 에이전트는 병목 지점, 확장성 문제\n\n【시험 포인트】\n▸ 멀티 계정 격리 패턴과 보안 이점\n▸ 실시간 vs 배치 동기화 선택 기준\n▸ 대규모 엔터프라이즈 아키텍처 설계",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS AppConfig — 구성 버전 관리 및 점진적 배포\n▸ 유효성 검사기 — 잘못된 구성 배포 사전 차단\n▸ 자동 롤백 — 모니터링 기반 배포 취소\n\n【정답 포인트】\n▸ AppConfig에 활성 모델 제공자 저장\n▸ Lambda가 런타임에 AppConfig에서 최신 구성값 읽음\n▸ 유효성 검사기로 잘못된 구성 배포 방지\n▸ 모니터링 기반 자동 롤백으로 안전한 배포 전략\n\n【오답 체크】\n(A) Parameter Store는 버전 관리/배포 전략 미지원\n(C) API Gateway는 라우팅 도구일 뿐 구성 관리 못함\n(D) S3 + AppConfig는 불필요하게 복잡한 구조\n\n【시험 포인트】\n▸ AppConfig vs Parameter Store의 핵심 차이\n▸ 점진적 배포 전략(Gradual Rollout)\n▸ 구성 변경 검증 및 자동 롤백",
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ 토큰 관리 — 프롬프트 길이 제어로 입력 절단 방지\n▸ 재시도 로직 — 지수 백오프로 타임아웃 처리\n▸ 응답 청크 처리 — 손상 감지 및 재전송\n\n【정답 포인트】\n▸ 토큰 계산/제한으로 프롬프트 크기 관리\n▸ 재시도 정책으로 API 타임아웃 처리\n▸ 응답 청크 손상 감지 및 재전송 메커니즘\n▸ 스트리밍으로 점진적 응답 전달\n\n【오답 체크】\n(A) 단순 재시도만으로는 토큰 제한 문제 미해결\n(B) 임계값 설정은 불균형한 토큰 할당\n(D) 라우팅은 근본 원인(타임아웃) 해결 못함\n\n【시험 포인트】\n▸ 토큰 제한 관리 전략\n▸ API 복원력 설계(재시도/백오프)\n▸ 응답 스트리밍으로 신뢰성 향상",
