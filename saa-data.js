window.SAA_QUESTIONS = [
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ S3 Transfer Acceleration — CloudFront 엣지 로케이션을 경유해 장거리 S3 업로드 속도를 대폭 향상. 전 세계 사이트에서 단일 버킷으로 빠르게 수집할 때 최적.\n\n【정답 포인트】\n▸ 핵심 서비스: S3\n\n【오답 체크】\n(C) Snowball은 오프라인 물리 전송 장치 — 인터넷 연결이 있으면 비효율적"
  },
  {
    "id": 2,
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon Athena — S3에 저장된 데이터를 표준 SQL로 서버리스 분석. 스캔한 데이터 양(TB당)으로 과금. Parquet·ORC 컬럼 형식으로 비용·성능 최적화.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 3,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ AWS Organizations — 다중 AWS 계정 중앙 관리. OU(조직 단위) 계층 구조. SCP로 권한 통제. 통합 결제·볼륨 할인.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 4,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon VPC(Virtual Private Cloud) — AWS 내 논리적으로 격리된 가상 네트워크. 서브넷·라우팅 테이블·IGW·NAT·SG·NACL로 구성.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 5,
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon EBS(Elastic Block Store) — EC2에 연결하는 블록 스토리지 볼륨. gp3(범용), io2(고성능 IOPS), st1(처리량 최적화), sc1(콜드) 타입. 단일 AZ 내 존재.\n▸ Amazon EFS(Elastic File System) — NFS 기반 완전관리형 공유 파일 시스템. 다수의 EC2·Lambda·컨테이너가 동시에 마운트 가능. 멀티-AZ 고가용성.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ ALB(Application Load Balancer) — L7 HTTP/HTTPS 부하분산. URL 경로·호스트·헤더 기반 라우팅. WebSocket·HTTP/2 지원. 타겟: EC2·ECS·Lambda·IP.\n\n【정답 포인트】\n▸ 핵심 서비스: EBS"
  },
  {
    "id": 6,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ AWS Snowball — 대용량 데이터를 물리 장치로 AWS에 오프라인 전송. Snowball Edge Storage Optimized(80TB), Compute Optimized(사전 처리용).\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 7,
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon SNS(Simple Notification Service) — 완전관리형 Pub-Sub 메시징. 토픽으로 다수 구독자(SQS·Lambda·HTTP·이메일·SMS)에 팬아웃. 최대 1,250만 구독자.\n\n【정답 포인트】\n▸ 정답은 SNS: Pub-Sub 팬아웃 — 다수 구독자에 동시 전달"
  },
  {
    "id": 8,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ EC2 Auto Scaling — 부하에 따라 EC2 인스턴스 수를 자동 조절. Target Tracking·Step·Scheduled·Predictive 정책. Min/Max/Desired 용량 설정.\n▸ Amazon SQS(Simple Queue Service) — 완전관리형 메시지 대기열. Standard(높은 처리량·순서 미보장)·FIFO(순서 보장·중복 제거). 최대 메시지 크기 256KB. 최대 14일 보관.\n\n【정답 포인트】\n▸ 핵심 서비스: EC2"
  },
  {
    "id": 9,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ S3 Glacier — 장기 아카이브 스토리지. Instant Retrieval(즉시), Flexible Retrieval(1–12h), Deep Archive(12–48h) 3단계. 비용 매우 저렴.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 10,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Amazon SQS(Simple Queue Service) — 완전관리형 메시지 대기열. Standard(높은 처리량·순서 미보장)·FIFO(순서 보장·중복 제거). 최대 메시지 크기 256KB. 최대 14일 보관.\n▸ SQS FIFO 대기열 — 메시지 순서 보장·정확히 한 번 처리. 초당 300(배치 시 3000) 메시지. 금융 거래·재고 관리 등 순서가 중요한 워크로드에 적합.\n▸ Amazon API Gateway — REST·HTTP·WebSocket API 생성·배포·관리. 인증(Cognito·Lambda Authorizer)·스로틀링·캐싱·스테이지 관리. Lambda·HTTP 엔드포인트 통합.\n\n【정답 포인트】\n▸ 정답은 Lambda: 서버리스 — 관리 불필요 + 이벤트 트리거 + 자동 스케일링"
  },
  {
    "id": 11,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS Secrets Manager — DB 자격증명·API 키 등 비밀 값 안전 저장·자동 로테이션. KMS 암호화. RDS·Redshift 자격증명 자동 갱신 지원. Parameter Store와 달리 로테이션 내장.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ Amazon Aurora — MySQL·PostgreSQL 호환 클라우드 네이티브 DB. 표준 MySQL 대비 최대 5배 성능. 6개 사본을 3개 AZ에 자동 분산. 자동 스토리지 확장(최대 128TB).\n\n【정답 포인트】\n▸ 정답은 Secrets Manager: 자격증명 자동 로테이션 + 암호화 저장 — DB 비밀번호 관리"
  },
  {
    "id": 12,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ ALB(Application Load Balancer) — L7 HTTP/HTTPS 부하분산. URL 경로·호스트·헤더 기반 라우팅. WebSocket·HTTP/2 지원. 타겟: EC2·ECS·Lambda·IP.\n▸ Amazon Route 53 — 완전관리형 DNS 서비스. 라우팅 정책: Simple·Weighted·Latency·Geolocation·Geoproximity·Failover·Multi-Value. 도메인 등록·Health Check 통합.\n▸ Amazon CloudFront — 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스. 정적·동적 콘텐츠 캐싱. DDoS 방어(Shield Standard 기본 포함). S3·ALB·EC2 오리진.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 13,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS Secrets Manager — DB 자격증명·API 키 등 비밀 값 안전 저장·자동 로테이션. KMS 암호화. RDS·Redshift 자격증명 자동 갱신 지원. Parameter Store와 달리 로테이션 내장.\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n\n【정답 포인트】\n▸ 정답은 Secrets Manager: 자격증명 자동 로테이션 + 암호화 저장 — DB 비밀번호 관리"
  },
  {
    "id": 14,
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon Aurora — MySQL·PostgreSQL 호환 클라우드 네이티브 DB. 표준 MySQL 대비 최대 5배 성능. 6개 사본을 3개 AZ에 자동 분산. 자동 스토리지 확장(최대 128TB).\n▸ EC2 Auto Scaling — 부하에 따라 EC2 인스턴스 수를 자동 조절. Target Tracking·Step·Scheduled·Predictive 정책. Min/Max/Desired 용량 설정.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ ALB(Application Load Balancer) — L7 HTTP/HTTPS 부하분산. URL 경로·호스트·헤더 기반 라우팅. WebSocket·HTTP/2 지원. 타겟: EC2·ECS·Lambda·IP.\n\n【정답 포인트】\n▸ 정답은 Aurora: MySQL/PostgreSQL 5배 성능 + 자동 스케일링 스토리지"
  },
  {
    "id": 15,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon QuickSight — 완전관리형 서버리스 BI 도구. ML 인사이트·자연어 쿼리(Q). SPICE 인메모리 캐시. S3·Athena·RDS·Redshift 데이터 소스.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n\n【정답 포인트】\n▸ 핵심 서비스: QuickSight"
  },
  {
    "id": 17,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ AWS IAM(Identity and Access Management) — AWS 리소스 접근 제어. 사용자·그룹·역할·정책으로 구성. 최소 권한 원칙. 자격증명: 액세스 키·MFA·패스워드.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 18,
    ...
    "answer": "AB",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Amazon SQS(Simple Queue Service) — 완전관리형 메시지 대기열. Standard(높은 처리량·순서 미보장)·FIFO(순서 보장·중복 제거). 최대 메시지 크기 256KB. 최대 14일 보관.\n\n【정답 포인트】\n▸ (A) S3: 객체 스토리지 서비스\n▸ (B) Lambda: 서버리스 이벤트 기반 컴퓨팅\n\n【오답 체크】\n(D) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화"
  },
  {
    "id": 19,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n▸ Amazon CloudFront — 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스. 정적·동적 콘텐츠 캐싱. DDoS 방어(Shield Standard 기본 포함). S3·ALB·EC2 오리진.\n\n【정답 포인트】\n▸ 핵심 서비스: S3\n\n【오답 체크】\n(B) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화"
  },
  {
    "id": 22,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ S3 Intelligent-Tiering — 접근 패턴을 자동 분석해 Frequent/Infrequent/Archive 계층 간 자동 이동. 접근 예측 불가 데이터에 적합.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 23,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ AWS Cost Explorer — 비용 및 사용량 시각화·예측 분석. 리저브드 인스턴스·Savings Plans 권고. 사용자 정의 보고서.\n\n【정답 포인트】\n▸ 핵심 서비스: EC2"
  },
  {
    "id": 25,
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Amazon SQS(Simple Queue Service) — 완전관리형 메시지 대기열. Standard(높은 처리량·순서 미보장)·FIFO(순서 보장·중복 제거). 최대 메시지 크기 256KB. 최대 14일 보관.\n▸ Amazon Aurora — MySQL·PostgreSQL 호환 클라우드 네이티브 DB. 표준 MySQL 대비 최대 5배 성능. 6개 사본을 3개 AZ에 자동 분산. 자동 스토리지 확장(최대 128TB).\n▸ Amazon API Gateway — REST·HTTP·WebSocket API 생성·배포·관리. 인증(Cognito·Lambda Authorizer)·스로틀링·캐싱·스테이지 관리. Lambda·HTTP 엔드포인트 통합.\n\n【정답 포인트】\n▸ 정답은 Lambda: 서버리스 — 관리 불필요 + 이벤트 트리거 + 자동 스케일링\n\n【오답 체크】\n(A) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화"
  },
  {
    "id": 26,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS Config — AWS 리소스 구성 변경 기록·평가. 규칙 기반 컴플라이언스 평가. 구성 히스토리·스냅샷. 변경 시 SNS 알림.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n\n【정답 포인트】\n▸ 정답은 Config: 리소스 구성 변경 이력 기록 + 컴플라이언스 평가"
  },
  {
    "id": 27,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon CloudWatch — AWS 리소스·애플리케이션 모니터링. 메트릭·로그·경보·대시보드·인사이트. 커스텀 메트릭 발행 가능. EC2 기본 메트릭: CPU·네트워크·디스크(메모리 제외).\n\n【정답 포인트】\n▸ 핵심 서비스: CloudWatch"
  },
  {
    "id": 28,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS IAM Identity Center(구 SSO) — 다중 계정·애플리케이션에 대한 중앙 집중 SSO. Active Directory·SAML IdP 연동. 최소 권한 접근 관리.\n▸ AWS Organizations — 다중 AWS 계정 중앙 관리. OU(조직 단위) 계층 구조. SCP로 권한 통제. 통합 결제·볼륨 할인.\n\n【정답 포인트】\n▸ 핵심 서비스: SSO"
  },
  {
    "id": 29,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ NLB(Network Load Balancer) — L4 TCP/UDP/TLS 부하분산. 초당 수백만 요청 처리, 고정 IP·EIP 지원. 극저지연. 게임·IoT·실시간 트래픽에 적합.\n▸ AWS Global Accelerator — AWS 글로벌 네트워크를 활용한 TCP/UDP 트래픽 가속. 고정 Anycast IP 2개 제공. 장애 시 자동 재라우팅. CDN이 아닌 네트워크 경로 최적화.\n▸ EC2 Auto Scaling — 부하에 따라 EC2 인스턴스 수를 자동 조절. Target Tracking·Step·Scheduled·Predictive 정책. Min/Max/Desired 용량 설정.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ 정답은 NLB: L4 고성능 초저지연 + 고정 IP — 실시간·게임 트래픽"
  },
  {
    "id": 30,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS Config — AWS 리소스 구성 변경 기록·평가. 규칙 기반 컴플라이언스 평가. 구성 히스토리·스냅샷. 변경 시 SNS 알림.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n▸ Amazon Redshift — 완전관리형 페타바이트급 클라우드 데이터 웨어하우스. 컬럼 기반 스토리지·MPP 아키텍처. OLAP 분석 쿼리에 최적화.\n\n【정답 포인트】\n▸ 정답은 Config: 리소스 구성 변경 이력 기록 + 컴플라이언스 평가"
  },
  {
    "id": 32,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n▸ Amazon Kinesis Data Streams — 실시간 데이터 스트리밍 수집. 샤드 단위 처리량(1MB/s 쓰기·2MB/s 읽기). 보관 기간 기본 24h(최대 365일). KCL로 소비.\n\n【정답 포인트】\n▸ 정답은 Lambda: 서버리스 — 관리 불필요 + 이벤트 트리거 + 자동 스케일링"
  },
  {
    "id": 34,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS CloudTrail — AWS 계정의 API 호출 이력(누가·언제·어디서·무엇을) 기록. 감사·보안 분석·규정 준수. 이벤트는 90일 기본 보관·S3 추가 보관.\n▸ AWS Config — AWS 리소스 구성 변경 기록·평가. 규칙 기반 컴플라이언스 평가. 구성 히스토리·스냅샷. 변경 시 SNS 알림.\n\n【정답 포인트】\n▸ 정답은 CloudTrail: API 호출 감사 기록 — 보안·규정 준수 이벤트 추적\n\n【오답 체크】\n(C) CloudWatch는 성능 모니터링 — API 감사 기록은 CloudTrail의 역할\n(D) CloudWatch는 성능 모니터링 — API 감사 기록은 CloudTrail의 역할"
  },
  {
    "id": 35,
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS Shield — DDoS 방어. Standard(무료·자동·L3/L4)·Advanced(유료·L7·비용 보호·DRT 대응팀).\n▸ AWS ELB(Elastic Load Balancing) — ALB·NLB·GWLB·CLB를 포함하는 로드밸런싱 서비스 총칭. 헬스 체크로 정상 타겟에만 트래픽 분산.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ Amazon VPC(Virtual Private Cloud) — AWS 내 논리적으로 격리된 가상 네트워크. 서브넷·라우팅 테이블·IGW·NAT·SG·NACL로 구성.\n\n【정답 포인트】\n▸ 핵심 서비스: Shield"
  },
  {
    "id": 36,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ AWS KMS(Key Management Service) — 암호화 키 생성·관리·감사. 대칭(AES-256)·비대칭(RSA·ECC) 키. S3·EBS·RDS·DynamoDB 등과 통합. CloudTrail로 키 사용 감사.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 37,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Systems Manager(SSM) — EC2·온프레미스 서버 운영 자동화. Parameter Store·Session Manager·Patch Manager·Run Command·Automation. SSH 없이 인스턴스 관리.\n▸ AWS IAM(Identity and Access Management) — AWS 리소스 접근 제어. 사용자·그룹·역할·정책으로 구성. 최소 권한 원칙. 자격증명: 액세스 키·MFA·패스워드.\n▸ Amazon SES(Simple Email Service) — 대용량 이메일 발송·수신. 트랜잭션 이메일·마케팅 메일. SMTP 또는 API 방식.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ 핵심 서비스: Systems Manager"
  },
  {
    "id": 38,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ S3 Glacier — 장기 아카이브 스토리지. Instant Retrieval(즉시), Flexible Retrieval(1–12h), Deep Archive(12–48h) 3단계. 비용 매우 저렴.\n▸ Amazon Kinesis Data Firehose — 스트리밍 데이터를 S3·Redshift·OpenSearch·HTTP 엔드포인트로 자동 적재. 완전관리형. 변환(Lambda)·압축·암호화 지원.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 41,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Direct Connect — 데이터센터와 AWS 간 전용 물리 네트워크 연결. 1/10/100Gbps. 일관된 레이턴시·고대역폭·보안 강화. VPN보다 안정적.\n▸ Amazon Connect — 완전관리형 클라우드 컨택센터. IVR·라우팅·실시간 분석. 분당 과금.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n\n【정답 포인트】\n▸ 정답은 Direct Connect: 전용 회선 일관된 대역폭·낮은 지연·보안 연결\n\n【오답 체크】\n(C) Snowball은 오프라인 물리 전송 장치 — 인터넷 연결이 있으면 비효율적"
  },
  {
    "id": 44,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon SNS(Simple Notification Service) — 완전관리형 Pub-Sub 메시징. 토픽으로 다수 구독자(SQS·Lambda·HTTP·이메일·SMS)에 팬아웃. 최대 1,250만 구독자.\n▸ Amazon Macie — S3 버킷의 민감 데이터(PII·신용카드·자격증명) 자동 탐지·분류. ML 기반. GDPR·HIPAA 규정 준수 지원.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 47,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon EFS(Elastic File System) — NFS 기반 완전관리형 공유 파일 시스템. 다수의 EC2·Lambda·컨테이너가 동시에 마운트 가능. 멀티-AZ 고가용성.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ 정답은 EFS: 다중 EC2 동시 마운트 공유 파일 시스템 — 멀티 AZ\n\n【오답 체크】\n(C) S3 Glacier는 장기 아카이브 — 빈번한 접근에는 부적합"
  },
  {
    "id": 49,
  ...
  },
  {
    ...
    "answer": "BD",
    "explanation": "【핵심 용어】\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Amazon EventBridge(CloudWatch Events) — 서버리스 이벤트 버스. AWS 서비스·SaaS·커스텀 이벤트를 규칙 기반으로 Lambda·SQS·Step Functions 등에 라우팅.\n▸ Amazon CloudWatch — AWS 리소스·애플리케이션 모니터링. 메트릭·로그·경보·대시보드·인사이트. 커스텀 메트릭 발행 가능. EC2 기본 메트릭: CPU·네트워크·디스크(메모리 제외).\n▸ Amazon SES(Simple Email Service) — 대용량 이메일 발송·수신. 트랜잭션 이메일·마케팅 메일. SMTP 또는 API 방식.\n\n【정답 포인트】\n▸ (B) SES: 대용량 이메일 발송·수신\n▸ (D) Lambda: 서버리스 이벤트 기반 컴퓨팅"
  },
  {
    "id": 52,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ S3 Glacier — 장기 아카이브 스토리지. Instant Retrieval(즉시), Flexible Retrieval(1–12h), Deep Archive(12–48h) 3단계. 비용 매우 저렴.\n▸ S3 Object Lock — WORM(Write Once Read Many) 모델로 객체 삭제·수정 방지. Compliance·Governance 두 모드. 규정 준수 보관에 사용.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 54,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon Route 53 — 완전관리형 DNS 서비스. 라우팅 정책: Simple·Weighted·Latency·Geolocation·Geoproximity·Failover·Multi-Value. 도메인 등록·Health Check 통합.\n▸ AWS ACM(Certificate Manager) — SSL/TLS 인증서 무료 발급·자동 갱신. ALB·CloudFront·API GW에 통합. EC2에는 직접 설치 불가(IAM 인증서 사용).\n▸ Amazon API Gateway — REST·HTTP·WebSocket API 생성·배포·관리. 인증(Cognito·Lambda Authorizer)·스로틀링·캐싱·스테이지 관리. Lambda·HTTP 엔드포인트 통합.\n\n【정답 포인트】\n▸ 정답은 Route 53: Failover 라우팅으로 장애 자동 전환 + 헬스 체크 통합"
  },
  {
    "id": 57,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon Rekognition — 이미지·영상 분석 API. 객체 탐지·얼굴 인식·텍스트 추출·유해 콘텐츠 감지. 서버리스 호출.\n\n【정답 포인트】\n▸ 핵심 서비스: Rekognition"
  },
  {
    "id": 58,
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ AWS Fargate — ECS/EKS용 서버리스 컨테이너 실행 엔진. EC2 노드 관리 불필요. vCPU·메모리 조합으로 과금. 컨테이너 격리 보안 강화.\n▸ Amazon ECS(Elastic Container Service) — AWS 완전관리형 컨테이너 오케스트레이션. Task Definition으로 컨테이너 구성. EC2 또는 Fargate 실행 모드.\n\n【정답 포인트】\n▸ 정답은 Fargate: 서버리스 컨테이너 — EC2 노드 관리 불필요"
  },
  {
    "id": 59,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ ALB(Application Load Balancer) — L7 HTTP/HTTPS 부하분산. URL 경로·호스트·헤더 기반 라우팅. WebSocket·HTTP/2 지원. 타겟: EC2·ECS·Lambda·IP.\n\n【정답 포인트】\n▸ 정답은 ALB: L7 URL/헤더 기반 라우팅 — 마이크로서비스 트래픽 분산"
  },
  {
    "id": 61,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n\n【정답 포인트】\n▸ 핵심 서비스: S3\n\n【오답 체크】\n(C) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화\n(D) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화"
  },
  {
    "id": 64,
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS Site-to-Site VPN — 온프레미스 네트워크와 VPC 간 IPsec 암호화 터널. Virtual Private Gateway(VGW) 또는 Transit Gateway 연결. 빠른 구성, 대역폭 제한.\n\n【정답 포인트】"
  },
  {
    "id": 65,
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon Textract — 문서에서 텍스트·표·양식 데이터 자동 추출. OCR 이상의 구조화 데이터 인식.\n▸ Amazon Comprehend — 자연어 처리(NLP) API. 감정 분석·개체 인식·주제 모델링·언어 감지.\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Amazon API Gateway — REST·HTTP·WebSocket API 생성·배포·관리. 인증(Cognito·Lambda Authorizer)·스로틀링·캐싱·스테이지 관리. Lambda·HTTP 엔드포인트 통합.\n\n【정답 포인트】\n▸ 핵심 서비스: Textract"
  },
  {
    "id": 66,
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n\n【정답 포인트】\n▸ 핵심 서비스: S3\n\n【오답 체크】\n(A) S3 Glacier는 장기 아카이브 — 빈번한 접근에는 부적합\n(D) S3 Glacier는 장기 아카이브 — 빈번한 접근에는 부적합"
  },
  {
    "id": 67,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS Site-to-Site VPN — 온프레미스 네트워크와 VPC 간 IPsec 암호화 터널. Virtual Private Gateway(VGW) 또는 Transit Gateway 연결. 빠른 구성, 대역폭 제한.\n▸ AWS Direct Connect — 데이터센터와 AWS 간 전용 물리 네트워크 연결. 1/10/100Gbps. 일관된 레이턴시·고대역폭·보안 강화. VPN보다 안정적.\n▸ Amazon Connect — 완전관리형 클라우드 컨택센터. IVR·라우팅·실시간 분석. 분당 과금.\n\n【정답 포인트】\n▸ 정답은 VPN: IPsec 암호화 터널 — 빠른 구성·인터넷 경유"
  },
  {
    "id": 69,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n\n【정답 포인트】\n▸ 정답은 DynamoDB: 완전관리형 NoSQL — 한 자릿수 밀리초 성능 + 자동 스케일링\n\n【오답 체크】\n(C) S3 Glacier는 장기 아카이브 — 빈번한 접근에는 부적합"
  },
  {
    "id": 72,
  ...
  },
  {
    ...
    "answer": "CD",
    "explanation": "【핵심 용어】\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ Amazon VPC(Virtual Private Cloud) — AWS 내 논리적으로 격리된 가상 네트워크. 서브넷·라우팅 테이블·IGW·NAT·SG·NACL로 구성.\n\n【정답 포인트】\n▸ (C) 배스천 호스트의 현재 보안 그룹을 회사의 외부 IP 범위에서만 인바운드 액세스를 허용하는 보안 그룹으로 교체합니다.\n▸ (D) 애플리케이션 인스턴스의 현재 보안 그룹을 배스천 호스트의 개인 IP 주소에서만 인바운드 SSH 액세스를 허용하는 보안 그룹으로"
  },
  {
    "id": 74,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS DataSync — 온프레미스 NFS/SMB/HDFS 스토리지와 S3·EFS·FSx 간 데이터를 자동·고속 전송. 초기 마이그레이션·반복 동기화에 적합.\n▸ AWS Direct Connect — 데이터센터와 AWS 간 전용 물리 네트워크 연결. 1/10/100Gbps. 일관된 레이턴시·고대역폭·보안 강화. VPN보다 안정적.\n▸ Amazon Connect — 완전관리형 클라우드 컨택센터. IVR·라우팅·실시간 분석. 분당 과금.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n\n【정답 포인트】\n▸ 정답은 DataSync: 온프레미스↔AWS 자동 고속 데이터 동기화"
  },
  {
    "id": 77,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Backup — EC2·EBS·RDS·DynamoDB·EFS 등 여러 서비스 백업을 중앙 집중 관리. 자동화된 백업 정책과 규정 준수 보고서 제공.\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n\n【정답 포인트】\n▸ 핵심 서비스: AWS Backup"
  },
  {
    "id": 79,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AMI(Amazon Machine Image) — EC2 인스턴스 부팅에 필요한 OS·소프트웨어 구성 스냅샷. 커스텀 AMI로 동일 구성 빠르게 복제 가능.\n▸ Amazon EBS(Elastic Block Store) — EC2에 연결하는 블록 스토리지 볼륨. gp3(범용), io2(고성능 IOPS), st1(처리량 최적화), sc1(콜드) 타입. 단일 AZ 내 존재.\n▸ AWS KMS(Key Management Service) — 암호화 키 생성·관리·감사. 대칭(AES-256)·비대칭(RSA·ECC) 키. S3·EBS·RDS·DynamoDB 등과 통합. CloudTrail로 키 사용 감사.\n\n【정답 포인트】\n▸ 핵심 서비스: AMI"
  },
  {
    "id": 81,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon CloudFront — 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스. 정적·동적 콘텐츠 캐싱. DDoS 방어(Shield Standard 기본 포함). S3·ALB·EC2 오리진.\n\n【정답 포인트】\n▸ 정답은 CloudFront: CDN 캐싱으로 글로벌 지연 단축 + DDoS 기본 방어"
  },
  {
    "id": 84,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon SQS(Simple Queue Service) — 완전관리형 메시지 대기열. Standard(높은 처리량·순서 미보장)·FIFO(순서 보장·중복 제거). 최대 메시지 크기 256KB. 최대 14일 보관.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n\n【정답 포인트】\n▸ 정답은 SQS: 비동기 분리 — 생산자·소비자 독립 스케일링 + 내구성 보장"
  },
  {
    "id": 99,
  ...
  },
  {
    ...
    "answer": "AB",
    "explanation": "【핵심 용어】\n▸ Amazon EFS(Elastic File System) — NFS 기반 완전관리형 공유 파일 시스템. 다수의 EC2·Lambda·컨테이너가 동시에 마운트 가능. 멀티-AZ 고가용성.\n▸ AWS DataSync — 온프레미스 NFS/SMB/HDFS 스토리지와 S3·EFS·FSx 간 데이터를 자동·고속 전송. 초기 마이그레이션·반복 동기화에 적합.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ (A) EFS: NFS 기반 완전관리형 공유 파일 시스템\n▸ (B) DataSync: 온프레미스 NFS/SMB/HDFS 스토리지와 S3·EFS·FSx 간 데이터를 자동·고속 전송"
  },
  {
    "id": 103,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ AWS Glue — 완전관리형 서버리스 ETL 서비스. 데이터 카탈로그(메타데이터 저장소)·크롤러(스키마 자동 감지)·ETL 작업(Spark 기반) 통합.\n\n【정답 포인트】"
  },
  {
    "id": 104,
    ...
    "answer": "AC",
    "explanation": "【핵심 용어】\n▸ Amazon CloudFront — 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스. 정적·동적 콘텐츠 캐싱. DDoS 방어(Shield Standard 기본 포함). S3·ALB·EC2 오리진.\n▸ AWS Shield — DDoS 방어. Standard(무료·자동·L3/L4)·Advanced(유료·L7·비용 보호·DRT 대응팀).\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ (A) Shield: DDoS 방어\n▸ (C) CloudFront: 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스"
  },
  {
    "id": 105,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS KMS(Key Management Service) — 암호화 키 생성·관리·감사. 대칭(AES-256)·비대칭(RSA·ECC) 키. S3·EBS·RDS·DynamoDB 등과 통합. CloudTrail로 키 사용 감사.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n\n【정답 포인트】\n▸ 정답은 KMS: 중앙 키 관리 + 자동 로테이션 + CloudTrail 감사"
  },
  {
    "id": 107,
  ...
  },
  {
    ...
    "answer": "AD",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon CloudFront — 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스. 정적·동적 콘텐츠 캐싱. DDoS 방어(Shield Standard 기본 포함). S3·ALB·EC2 오리진.\n\n【정답 포인트】\n▸ (A) CloudFront: 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스\n▸ (D) S3: 객체 스토리지 서비스"
  },
  {
    "id": 117,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon CloudWatch — AWS 리소스·애플리케이션 모니터링. 메트릭·로그·경보·대시보드·인사이트. 커스텀 메트릭 발행 가능. EC2 기본 메트릭: CPU·네트워크·디스크(메모리 제외).\n▸ CloudWatch Logs — 로그 수집·저장·검색·분석. 로그 그룹·스트림 구조. Logs Insights로 쿼리. Lambda·EC2·ECS·API GW 로그 통합.\n▸ Amazon OpenSearch Service — Elasticsearch 기반 완전관리형 검색·로그 분석. Kibana(OpenSearch Dashboards) 통합. VPC 내 배포 가능.\n\n【정답 포인트】\n▸ 핵심 서비스: CloudWatch"
  },
  {
    "id": 118,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS WAF(Web Application Firewall) — HTTP/HTTPS 트래픽 필터링. SQL 인젝션·XSS·봇 차단. CloudFront·ALB·API GW·AppSync에 연결. Web ACL·Rule Group으로 구성.\n▸ AWS Firewall Manager — Organizations 내 WAF·Shield·SG·Network Firewall 정책 중앙 관리·자동 적용.\n▸ Amazon API Gateway — REST·HTTP·WebSocket API 생성·배포·관리. 인증(Cognito·Lambda Authorizer)·스로틀링·캐싱·스테이지 관리. Lambda·HTTP 엔드포인트 통합.\n\n【정답 포인트】\n▸ 정답은 WAF: L7 웹 공격(SQL 인젝션·XSS) 차단 — CloudFront·ALB 연결"
  },
  {
    "id": 120,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ S3 Glacier — 장기 아카이브 스토리지. Instant Retrieval(즉시), Flexible Retrieval(1–12h), Deep Archive(12–48h) 3단계. 비용 매우 저렴.\n▸ S3 Lifecycle 정책 — 객체를 기간에 따라 자동으로 다른 스토리지 클래스로 전환하거나 삭제. 비용 최적화 핵심 도구.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 127,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon EKS(Elastic Kubernetes Service) — AWS 완전관리형 Kubernetes. 업스트림 K8s 완전 호환. EC2·Fargate·Outposts 노드 지원.\n\n【정답 포인트】\n▸ 정답은 EKS: 완전관리형 Kubernetes — 업스트림 K8s 완전 호환"
  },
  {
    "id": 129,
    ...
    "answer": "AE",
    "explanation": "【핵심 용어】\n▸ AWS Fargate — ECS/EKS용 서버리스 컨테이너 실행 엔진. EC2 노드 관리 불필요. vCPU·메모리 조합으로 과금. 컨테이너 격리 보안 강화.\n▸ Amazon ECS(Elastic Container Service) — AWS 완전관리형 컨테이너 오케스트레이션. Task Definition으로 컨테이너 구성. EC2 또는 Fargate 실행 모드.\n▸ Amazon Aurora — MySQL·PostgreSQL 호환 클라우드 네이티브 DB. 표준 MySQL 대비 최대 5배 성능. 6개 사본을 3개 AZ에 자동 분산. 자동 스토리지 확장(최대 128TB).\n\n【정답 포인트】\n▸ (A) Aurora: MySQL·PostgreSQL 호환 클라우드 네이티브 DB\n▸ (E) Fargate: ECS/EKS용 서버리스 컨테이너 실행 엔진"
  },
  {
    "id": 130,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ EC2 Auto Scaling — 부하에 따라 EC2 인스턴스 수를 자동 조절. Target Tracking·Step·Scheduled·Predictive 정책. Min/Max/Desired 용량 설정.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ ALB(Application Load Balancer) — L7 HTTP/HTTPS 부하분산. URL 경로·호스트·헤더 기반 라우팅. WebSocket·HTTP/2 지원. 타겟: EC2·ECS·Lambda·IP.\n\n【정답 포인트】\n▸ 정답은 EC2 Auto Scaling: 부하 기반 자동 인스턴스 수 조정 — 비용·가용성 최적화"
  },
  {
    "id": 131,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon VPC(Virtual Private Cloud) — AWS 내 논리적으로 격리된 가상 네트워크. 서브넷·라우팅 테이블·IGW·NAT·SG·NACL로 구성.\n▸ AWS PrivateLink — VPC 엔드포인트를 통해 AWS 서비스·SaaS를 인터넷 노출 없이 프라이빗하게 접근. Interface Endpoint(ENI 기반).\n\n【정답 포인트】\n▸ 핵심 서비스: VPC"
  },
  {
    "id": 136,
    ...
    "answer": "AC",
    "explanation": "【핵심 용어】\n▸ AWS DMS(Database Migration Service) — 온프레미스·클라우드 DB를 AWS로 마이그레이션. 동종·이종 DB 간 CDC(변경 데이터 캡처) 지원.\n▸ AWS MGN(Application Migration Service) — 에이전트 기반 lift-and-shift 마이그레이션. 블록 레벨 복제로 다운타임 최소화.\n▸ Amazon Aurora — MySQL·PostgreSQL 호환 클라우드 네이티브 DB. 표준 MySQL 대비 최대 5배 성능. 6개 사본을 3개 AZ에 자동 분산. 자동 스토리지 확장(최대 128TB).\n\n【정답 포인트】\n▸ (A) 지속적인 복제 작업을 만듭니다.\n▸ (C) DMS: 온프레미스·클라우드 DB를 AWS로 마이그레이션"
  },
  {
    "id": 137,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Organizations — 다중 AWS 계정 중앙 관리. OU(조직 단위) 계층 구조. SCP로 권한 통제. 통합 결제·볼륨 할인.\n\n【정답 포인트】\n▸ 정답은 Organizations: 다중 계정 중앙 관리 + SCP 권한 통제 + 통합 결제"
  },
  {
    "id": 138,
  ...
  },
  {
    ...
    "answer": "AC",
    "explanation": "【핵심 용어】\n▸ EC2 Savings Plans — 특정 사용량($/시간)을 1·3년 약정 시 최대 72% 할인. 인스턴스 패밀리·리전·OS 변경 유연. Compute Savings Plans는 Fargate·Lambda도 적용.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ AWS Fargate — ECS/EKS용 서버리스 컨테이너 실행 엔진. EC2 노드 관리 불필요. vCPU·메모리 조합으로 과금. 컨테이너 격리 보안 강화.\n\n【정답 포인트】\n▸ (A) 데이터 수집 계층에 스팟 인스턴스 사용\n▸ (C) EC2 Savings Plans: 특정 사용량($/시간)을 1·3년 약정 시 최대 72% 할인"
  },
  {
    "id": 141,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon ECS(Elastic Container Service) — AWS 완전관리형 컨테이너 오케스트레이션. Task Definition으로 컨테이너 구성. EC2 또는 Fargate 실행 모드.\n▸ ALB(Application Load Balancer) — L7 HTTP/HTTPS 부하분산. URL 경로·호스트·헤더 기반 라우팅. WebSocket·HTTP/2 지원. 타겟: EC2·ECS·Lambda·IP.\n\n【정답 포인트】\n▸ 정답은 ECS: 완전관리형 컨테이너 오케스트레이션 — EC2/Fargate 실행"
  },
  {
    "id": 144,
  ...
  },
  {
    ...
    "answer": "AC",
    "explanation": "【핵심 용어】\n▸ Amazon VPC(Virtual Private Cloud) — AWS 내 논리적으로 격리된 가상 네트워크. 서브넷·라우팅 테이블·IGW·NAT·SG·NACL로 구성.\n▸ SCP(Service Control Policy) — AWS Organizations에서 OU·계정 레벨 최대 허용 권한 한도 설정. IAM 정책보다 우선. 거부 목록·허용 목록 방식.\n▸ AWS Organizations — 다중 AWS 계정 중앙 관리. OU(조직 단위) 계층 구조. SCP로 권한 통제. 통합 결제·볼륨 할인.\n▸ AWS Control Tower — 다중 계정 AWS 환경 자동 설정·거버넌스. Guardrails(예방적·탐지적 제어). Landing Zone 구성 자동화.\n\n【정답 포인트】\n▸ (A) Control Tower: 다중 계정 AWS 환경 자동 설정·거버넌스\n▸ (C) VPC: AWS 내 논리적으로 격리된 가상 네트워크"
  },
  {
    "id": 152,
  ...
  },
  {
    ...
    "answer": "AE",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon Athena — S3에 저장된 데이터를 표준 SQL로 서버리스 분석. 스캔한 데이터 양(TB당)으로 과금. Parquet·ORC 컬럼 형식으로 비용·성능 최적화.\n▸ AWS Glue — 완전관리형 서버리스 ETL 서비스. 데이터 카탈로그(메타데이터 저장소)·크롤러(스키마 자동 감지)·ETL 작업(Spark 기반) 통합.\n▸ Amazon QuickSight — 완전관리형 서버리스 BI 도구. ML 인사이트·자연어 쿼리(Q). SPICE 인메모리 캐시. S3·Athena·RDS·Redshift 데이터 소스.\n\n【정답 포인트】\n▸ (A) Athena: S3에 저장된 데이터를 표준 SQL로 서버리스 분석\n▸ (E) S3: 객체 스토리지 서비스"
  },
  {
    "id": 157,
    ...
    "answer": "DE",
    "explanation": "【핵심 용어】\n▸ AWS Backup — EC2·EBS·RDS·DynamoDB·EFS 등 여러 서비스 백업을 중앙 집중 관리. 자동화된 백업 정책과 규정 준수 보고서 제공.\n▸ Amazon CloudWatch — AWS 리소스·애플리케이션 모니터링. 메트릭·로그·경보·대시보드·인사이트. 커스텀 메트릭 발행 가능. EC2 기본 메트릭: CPU·네트워크·디스크(메모리 제외).\n▸ CloudWatch Logs — 로그 수집·저장·검색·분석. 로그 그룹·스트림 구조. Logs Insights로 쿼리. Lambda·EC2·ECS·API GW 로그 통합.\n▸ Amazon Aurora — MySQL·PostgreSQL 호환 클라우드 네이티브 DB. 표준 MySQL 대비 최대 5배 성능. 6개 사본을 3개 AZ에 자동 분산. 자동 스토리지 확장(최대 128TB).\n\n【정답 포인트】\n▸ (D) CloudWatch: AWS 리소스·애플리케이션 모니터링\n▸ (E) AWS Backup: EC2·EBS·RDS·DynamoDB·EFS 등 여러 서비스 백업을 중앙 집중 관리"
  },
  {
    "id": 158,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n\n【정답 포인트】\n▸ 핵심 서비스: S3\n\n【오답 체크】\n(B) S3 Glacier는 장기 아카이브 — 빈번한 접근에는 부적합"
  },
  {
    "id": 161,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon FSx for Lustre — HPC·ML용 고성능 병렬 파일 시스템. S3와 네이티브 통합. 수백만 IOPS·수백 GB/s 처리량.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ 핵심 서비스: S3\n\n【오답 체크】\n(C) S3 Glacier는 장기 아카이브 — 빈번한 접근에는 부적합"
  },
  {
    "id": 163,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n▸ DynamoDB Accelerator(DAX) — DynamoDB 인메모리 캐시. 읽기 응답 시간을 밀리초→마이크로초로 단축. 쓰기는 DynamoDB로 통과.\n\n【정답 포인트】\n▸ 정답은 DynamoDB: 완전관리형 NoSQL — 한 자릿수 밀리초 성능 + 자동 스케일링"
  },
  {
    "id": 178,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ AWS IAM(Identity and Access Management) — AWS 리소스 접근 제어. 사용자·그룹·역할·정책으로 구성. 최소 권한 원칙. 자격증명: 액세스 키·MFA·패스워드.\n▸ AWS KMS(Key Management Service) — 암호화 키 생성·관리·감사. 대칭(AES-256)·비대칭(RSA·ECC) 키. S3·EBS·RDS·DynamoDB 등과 통합. CloudTrail로 키 사용 감사.\n▸ SSM Parameter Store — 구성 데이터·평문/암호화 비밀 값 저장. 무료 Standard(4KB)·유료 Advanced(8KB) 파라미터. KMS 통합으로 암호화.\n\n【정답 포인트】\n▸ 핵심 서비스: EC2"
  },
  {
    "id": 180,
  ...
  },
  {
    ...
    "answer": "AD",
    "explanation": "【핵심 용어】\n▸ AWS Fargate — ECS/EKS용 서버리스 컨테이너 실행 엔진. EC2 노드 관리 불필요. vCPU·메모리 조합으로 과금. 컨테이너 격리 보안 강화.\n▸ Amazon ECS(Elastic Container Service) — AWS 완전관리형 컨테이너 오케스트레이션. Task Definition으로 컨테이너 구성. EC2 또는 Fargate 실행 모드.\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n\n【정답 포인트】\n▸ (A) RDS: MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB\n▸ (D) Fargate: ECS/EKS용 서버리스 컨테이너 실행 엔진"
  },
  {
    "id": 188,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Elastic Beanstalk — 코드만 업로드하면 EC2·LB·Auto Scaling·RDS 등 인프라를 자동 프로비저닝. PaaS 형태. 환경 설정 세부 제어 가능.\n\n【정답 포인트】\n▸ 핵심 서비스: Elastic Beanstalk"
  },
  {
    "id": 191,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n▸ DynamoDB TTL(Time to Live) — 만료 타임스탬프 속성으로 항목을 자동 삭제. 세션·임시 데이터 관리에 활용. 추가 비용 없음.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ 정답은 DynamoDB: 완전관리형 NoSQL — 한 자릿수 밀리초 성능 + 자동 스케일링"
  },
  {
    "id": 197,
    ...
    "answer": "BE",
    "explanation": "【핵심 용어】\n▸ AWS Elastic Beanstalk — 코드만 업로드하면 EC2·LB·Auto Scaling·RDS 등 인프라를 자동 프로비저닝. PaaS 형태. 환경 설정 세부 제어 가능.\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n▸ AWS DMS(Database Migration Service) — 온프레미스·클라우드 DB를 AWS로 마이그레이션. 동종·이종 DB 간 CDC(변경 데이터 캡처) 지원.\n▸ AWS MGN(Application Migration Service) — 에이전트 기반 lift-and-shift 마이그레이션. 블록 레벨 복제로 다운타임 최소화.\n\n【정답 포인트】\n▸ (B) Elastic Beanstalk: 코드만 업로드하면 EC2·LB·Auto Scaling·RDS 등 인프라를 자동 프로비저닝\n▸ (E) RDS: MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB"
  },
  {
    "id": 198,
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS Fargate — ECS/EKS용 서버리스 컨테이너 실행 엔진. EC2 노드 관리 불필요. vCPU·메모리 조합으로 과금. 컨테이너 격리 보안 강화.\n▸ Amazon EKS(Elastic Kubernetes Service) — AWS 완전관리형 Kubernetes. 업스트림 K8s 완전 호환. EC2·Fargate·Outposts 노드 지원.\n▸ Amazon DocumentDB — MongoDB 호환 완전관리형 도큐먼트 DB. JSON 도큐먼트 스토리지. Aurora와 유사한 스토리지 아키텍처.\n\n【정답 포인트】\n▸ 정답은 Fargate: 서버리스 컨테이너 — EC2 노드 관리 불필요"
  },
  {
    "id": 199,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon Athena — S3에 저장된 데이터를 표준 SQL로 서버리스 분석. 스캔한 데이터 양(TB당)으로 과금. Parquet·ORC 컬럼 형식으로 비용·성능 최적화.\n\n【정답 포인트】\n▸ 정답은 Athena: S3 데이터 서버리스 SQL 쿼리 — 스캔 데이터 기준 과금"
  },
  {
    "id": 200,
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon Cognito — 웹·모바일 앱 사용자 인증·인가. User Pool(회원가입·로그인·MFA)·Identity Pool(AWS 리소스 임시 접근). OAuth2·SAML·소셜 로그인 통합.\n▸ Amazon API Gateway — REST·HTTP·WebSocket API 생성·배포·관리. 인증(Cognito·Lambda Authorizer)·스로틀링·캐싱·스테이지 관리. Lambda·HTTP 엔드포인트 통합.\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n\n【정답 포인트】\n▸ 정답은 Cognito: 앱 사용자 인증(User Pool) + AWS 리소스 접근(Identity Pool)"
  },
  {
    "id": 201,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon Pinpoint — 다채널(이메일·SMS·푸시·음성) 마케팅 커뮤니케이션. 사용자 세그먼트·캠페인 분석.\n\n【정답 포인트】\n▸ 핵심 서비스: Pinpoint"
  },
  {
    "id": 202,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n▸ AWS Glue — 완전관리형 서버리스 ETL 서비스. 데이터 카탈로그(메타데이터 저장소)·크롤러(스키마 자동 감지)·ETL 작업(Spark 기반) 통합.\n▸ AWS Lake Formation — S3 기반 데이터 레이크 구축·관리 자동화. 세분화된 테이블·컬럼 수준 접근 제어. Glue와 통합.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 205,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon ElastiCache — 완전관리형 인메모리 캐시. Redis(복제·지속성·Pub-Sub)·Memcached(멀티스레드·단순 캐시) 엔진 선택. DB 읽기 부하 감소·세션 스토어.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ ALB(Application Load Balancer) — L7 HTTP/HTTPS 부하분산. URL 경로·호스트·헤더 기반 라우팅. WebSocket·HTTP/2 지원. 타겟: EC2·ECS·Lambda·IP.\n\n【정답 포인트】\n▸ 정답은 ElastiCache: 인메모리 캐시로 DB 부하 경감 + 밀리초 응답"
  },
  {
    "id": 210,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Glue — 완전관리형 서버리스 ETL 서비스. 데이터 카탈로그(메타데이터 저장소)·크롤러(스키마 자동 감지)·ETL 작업(Spark 기반) 통합.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n\n【정답 포인트】\n▸ 정답은 Glue: 서버리스 ETL + 데이터 카탈로그 + 크롤러 자동 스키마 감지"
  },
  {
    "id": 215,
  ...
  },
  {
    ...
    "answer": "AE",
    "explanation": "【핵심 용어】\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ (A) 소스 0.0.0.0/0에서 TCP 포트 443을 허용하는 규칙으로 보안 그룹을 생성합니다.\n▸ (E) 소스 0.0.0.0/0 에서 인바운드 TCP 포트 443 을 허용하고 대상 0.0.0.0/0 으로 아웃바운드 TCP 포트 32"
  },
  {
    "id": 219,
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ Amazon CloudWatch — AWS 리소스·애플리케이션 모니터링. 메트릭·로그·경보·대시보드·인사이트. 커스텀 메트릭 발행 가능. EC2 기본 메트릭: CPU·네트워크·디스크(메모리 제외).\n▸ AWS CloudFormation — IaC(Infrastructure as Code) 서비스. YAML·JSON 템플릿으로 AWS 리소스 스택 선언적 프로비저닝·업데이트·삭제. 드리프트 탐지.\n\n【정답 포인트】\n▸ 핵심 서비스: EC2"
  },
  {
    "id": 220,
  ...
  },
  {
    ...
    "answer": "AD",
    "explanation": "【핵심 용어】\n▸ Amazon EKS(Elastic Kubernetes Service) — AWS 완전관리형 Kubernetes. 업스트림 K8s 완전 호환. EC2·Fargate·Outposts 노드 지원.\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n▸ Amazon VPC(Virtual Private Cloud) — AWS 내 논리적으로 격리된 가상 네트워크. 서브넷·라우팅 테이블·IGW·NAT·SG·NACL로 구성.\n▸ AWS IAM(Identity and Access Management) — AWS 리소스 접근 제어. 사용자·그룹·역할·정책으로 구성. 최소 권한 원칙. 자격증명: 액세스 키·MFA·패스워드.\n\n【정답 포인트】\n▸ (A) EKS: AWS 완전관리형 Kubernetes\n▸ (D) DynamoDB: 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB"
  },
  {
    "id": 224,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon Redshift — 완전관리형 페타바이트급 클라우드 데이터 웨어하우스. 컬럼 기반 스토리지·MPP 아키텍처. OLAP 분석 쿼리에 최적화.\n▸ Amazon Kinesis Data Firehose — 스트리밍 데이터를 S3·Redshift·OpenSearch·HTTP 엔드포인트로 자동 적재. 완전관리형. 변환(Lambda)·압축·암호화 지원.\n\n【정답 포인트】\n▸ 정답은 Redshift: MPP 컬럼형 DW — 대규모 OLAP 분석 고성능"
  },
  {
    "id": 226,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon Aurora — MySQL·PostgreSQL 호환 클라우드 네이티브 DB. 표준 MySQL 대비 최대 5배 성능. 6개 사본을 3개 AZ에 자동 분산. 자동 스토리지 확장(최대 128TB).\n▸ Aurora Serverless — 자동으로 용량을 조절하는 온디맨드 Aurora. 간헐적·예측 불가 워크로드에 적합. v2는 초당 스케일 조정.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ 정답은 Aurora: MySQL/PostgreSQL 5배 성능 + 자동 스케일링 스토리지"
  },
  {
    "id": 230,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ AWS DMS(Database Migration Service) — 온프레미스·클라우드 DB를 AWS로 마이그레이션. 동종·이종 DB 간 CDC(변경 데이터 캡처) 지원.\n▸ AWS SCT(Schema Conversion Tool) — 이종 DB 스키마·저장 프로시저 자동 변환. Oracle→Aurora 등.\n▸ AWS MGN(Application Migration Service) — 에이전트 기반 lift-and-shift 마이그레이션. 블록 레벨 복제로 다운타임 최소화.\n▸ Amazon Aurora — MySQL·PostgreSQL 호환 클라우드 네이티브 DB. 표준 MySQL 대비 최대 5배 성능. 6개 사본을 3개 AZ에 자동 분산. 자동 스토리지 확장(최대 128TB).\n\n【정답 포인트】\n▸ 핵심 서비스: DMS"
  },
  {
    "id": 236,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS Storage Gateway — 온프레미스와 AWS 클라우드 스토리지를 연결하는 하이브리드 서비스. File(S3 연동), Volume(iSCSI), Tape(Glacier 아카이브) 3가지 유형.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n\n【정답 포인트】\n▸ 정답은 Storage Gateway: 온프레미스 스토리지를 AWS와 하이브리드 연결"
  },
  {
    "id": 244,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon FSx for Windows File Server — SMB 프로토콜 기반 완전관리형 Windows 파일 시스템. Active Directory 통합. Windows 워크로드에 최적.\n\n【정답 포인트】"
  },
  {
    "id": 261,
    ...
    "answer": "AC",
    "explanation": "【핵심 용어】\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Lambda@Edge — CloudFront 엣지 로케이션에서 Lambda를 실행. 사용자 가까이서 요청/응답 커스터마이징. 레이턴시 단축·지역별 콘텐츠 처리.\n▸ Amazon CloudFront — 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스. 정적·동적 콘텐츠 캐싱. DDoS 방어(Shield Standard 기본 포함). S3·ALB·EC2 오리진.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ (A) CloudFront: 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스\n▸ (C) Lambda: 서버리스 이벤트 기반 컴퓨팅\n\n【오답 체크】\n(D) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화\n(E) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화"
  },
  {
    "id": 262,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon Kinesis Data Firehose — 스트리밍 데이터를 S3·Redshift·OpenSearch·HTTP 엔드포인트로 자동 적재. 완전관리형. 변환(Lambda)·압축·암호화 지원.\n▸ Amazon Kinesis Data Analytics — SQL 또는 Apache Flink로 스트리밍 데이터 실시간 분석. Kinesis Streams·Firehose와 통합.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 268,
  ...
  },
  {
    ...
    "answer": "AD",
    "explanation": "【핵심 용어】\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n▸ EC2 Auto Scaling — 부하에 따라 EC2 인스턴스 수를 자동 조절. Target Tracking·Step·Scheduled·Predictive 정책. Min/Max/Desired 용량 설정.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ (A) RDS: MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB\n▸ (D) EC2 Auto Scaling: 부하에 따라 EC2 인스턴스 수를 자동 조절"
  },
  {
    "id": 277,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS Storage Gateway — 온프레미스와 AWS 클라우드 스토리지를 연결하는 하이브리드 서비스. File(S3 연동), Volume(iSCSI), Tape(Glacier 아카이브) 3가지 유형.\n\n【정답 포인트】\n▸ 정답은 Storage Gateway: 온프레미스 스토리지를 AWS와 하이브리드 연결\n\n【오답 체크】\n(A) Snowball은 오프라인 물리 전송 장치 — 인터넷 연결이 있으면 비효율적\n(B) Snowball은 오프라인 물리 전송 장치 — 인터넷 연결이 있으면 비효율적"
  },
  {
    "id": 294,
  ...
  },
  {
    ...
    "answer": "BD",
    "explanation": "【핵심 용어】\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n▸ AWS Trusted Advisor — 비용 최적화·보안·성능·내결함성·서비스 한도 5가지 영역 자동 점검 및 권고. Business/Enterprise 지원 플랜에서 전체 항목 제공.\n\n【정답 포인트】\n▸ (B) RDS: MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB\n▸ (D) RDS: MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB"
  },
  {
    "id": 309,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Amazon Inspector — EC2·ECR 컨테이너 이미지·Lambda 취약점 자동 스캔. CVE 기반. 지속적 재스캔. 우선순위 점수 제공.\n\n【정답 포인트】\n▸ 핵심 서비스: EC2\n\n【오답 체크】\n(A) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화\n(B) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화"
  },
  {
    "id": 316,
  ...
  },
  {
    ...
    "answer": "AD",
    "explanation": "【핵심 용어】\n▸ AWS CloudTrail — AWS 계정의 API 호출 이력(누가·언제·어디서·무엇을) 기록. 감사·보안 분석·규정 준수. 이벤트는 90일 기본 보관·S3 추가 보관.\n▸ AWS Config — AWS 리소스 구성 변경 기록·평가. 규칙 기반 컴플라이언스 평가. 구성 히스토리·스냅샷. 변경 시 SNS 알림.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ (A) CloudTrail: AWS 계정의 API 호출 이력(누가·언제·어디서·무엇을) 기록\n▸ (D) Config: AWS 리소스 구성 변경 기록·평가"
  },
  {
    "id": 319,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon Kinesis Data Streams — 실시간 데이터 스트리밍 수집. 샤드 단위 처리량(1MB/s 쓰기·2MB/s 읽기). 보관 기간 기본 24h(최대 365일). KCL로 소비.\n▸ Amazon Kinesis Data Analytics — SQL 또는 Apache Flink로 스트리밍 데이터 실시간 분석. Kinesis Streams·Firehose와 통합.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ 정답은 Kinesis Data Streams: 실시간 스트리밍 수집·처리 — 샤드 단위 병렬 처리"
  },
  {
    "id": 321,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ EC2 Savings Plans — 특정 사용량($/시간)을 1·3년 약정 시 최대 72% 할인. 인스턴스 패밀리·리전·OS 변경 유연. Compute Savings Plans는 Fargate·Lambda도 적용.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ 정답은 EC2 Savings Plans: 유연한 약정 할인 — 인스턴스 패밀리·리전 변경 가능"
  },
  {
    "id": 348,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ AWS Step Functions — 서버리스 워크플로 오케스트레이션. 상태 머신으로 Lambda·ECS·SageMaker 등 조합. 재시도·병렬·분기 처리. Express(단기)·Standard(장기) 워크플로.\n\n【정답 포인트】\n▸ 정답은 Lambda: 서버리스 — 관리 불필요 + 이벤트 트리거 + 자동 스케일링\n\n【오답 체크】\n(B) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화"
  },
  {
    "id": 352,
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Global Accelerator — AWS 글로벌 네트워크를 활용한 TCP/UDP 트래픽 가속. 고정 Anycast IP 2개 제공. 장애 시 자동 재라우팅. CDN이 아닌 네트워크 경로 최적화.\n\n【정답 포인트】\n▸ 정답은 Global Accelerator: AWS 백본망 + Anycast IP로 TCP/UDP 성능 개선·장애 복구"
  },
  {
    "id": 353,
  ...
  },
  {
    ...
    "answer": "AD",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon FSx for Windows File Server — SMB 프로토콜 기반 완전관리형 Windows 파일 시스템. Active Directory 통합. Windows 워크로드에 최적.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ Amazon CloudFront — 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스. 정적·동적 콘텐츠 캐싱. DDoS 방어(Shield Standard 기본 포함). S3·ALB·EC2 오리진.\n\n【정답 포인트】\n▸ (A) S3: 객체 스토리지 서비스\n▸ (D) FSx for Windows: SMB 프로토콜 기반 완전관리형 Windows 파일 시스템"
  },
  {
    "id": 358,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS Batch — 완전관리형 배치 컴퓨팅. Job Queue·Job Definition으로 워크로드 관리. EC2·Spot·Fargate로 실행. HPC·ML·ETL 배치 처리.\n▸ Amazon EventBridge(CloudWatch Events) — 서버리스 이벤트 버스. AWS 서비스·SaaS·커스텀 이벤트를 규칙 기반으로 Lambda·SQS·Step Functions 등에 라우팅.\n▸ Amazon CloudWatch — AWS 리소스·애플리케이션 모니터링. 메트릭·로그·경보·대시보드·인사이트. 커스텀 메트릭 발행 가능. EC2 기본 메트릭: CPU·네트워크·디스크(메모리 제외).\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n\n【정답 포인트】\n▸ 핵심 서비스: Batch"
  },
  {
    "id": 370,
  ...
  },
  {
    ...
    "answer": "BD",
    "explanation": "【핵심 용어】\n▸ Amazon EBS(Elastic Block Store) — EC2에 연결하는 블록 스토리지 볼륨. gp3(범용), io2(고성능 IOPS), st1(처리량 최적화), sc1(콜드) 타입. 단일 AZ 내 존재.\n▸ Amazon EKS(Elastic Kubernetes Service) — AWS 완전관리형 Kubernetes. 업스트림 K8s 완전 호환. EC2·Fargate·Outposts 노드 지원.\n▸ AWS IAM(Identity and Access Management) — AWS 리소스 접근 제어. 사용자·그룹·역할·정책으로 구성. 최소 권한 원칙. 자격증명: 액세스 키·MFA·패스워드.\n▸ AWS KMS(Key Management Service) — 암호화 키 생성·관리·감사. 대칭(AES-256)·비대칭(RSA·ECC) 키. S3·EBS·RDS·DynamoDB 등과 통합. CloudTrail로 키 사용 감사.\n\n【정답 포인트】\n▸ (B) EBS: EC2에 연결하는 블록 스토리지 볼륨\n▸ (D) EKS: AWS 완전관리형 Kubernetes"
  },
  {
    "id": 372,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ Amazon VPC(Virtual Private Cloud) — AWS 내 논리적으로 격리된 가상 네트워크. 서브넷·라우팅 테이블·IGW·NAT·SG·NACL로 구성.\n▸ AWS Transit Gateway — 수백 개 VPC·온프레미스 네트워크를 허브-스포크 방식으로 연결. 전이적 라우팅 지원. VPN·Direct Connect 통합.\n▸ AWS Direct Connect — 데이터센터와 AWS 간 전용 물리 네트워크 연결. 1/10/100Gbps. 일관된 레이턴시·고대역폭·보안 강화. VPN보다 안정적.\n▸ Amazon Connect — 완전관리형 클라우드 컨택센터. IVR·라우팅·실시간 분석. 분당 과금.\n\n【정답 포인트】\n▸ 핵심 서비스: VPC"
  },
  {
    "id": 375,
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ AWS Step Functions — 서버리스 워크플로 오케스트레이션. 상태 머신으로 Lambda·ECS·SageMaker 등 조합. 재시도·병렬·분기 처리. Express(단기)·Standard(장기) 워크플로.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n\n【정답 포인트】\n▸ 정답은 Step Functions: 서버리스 워크플로 — 재시도·병렬·분기 오케스트레이션"
  },
  {
    "id": 376,
  ...
  },
  {
    ...
    "answer": "AD",
    "explanation": "【핵심 용어】\n▸ Amazon ElastiCache — 완전관리형 인메모리 캐시. Redis(복제·지속성·Pub-Sub)·Memcached(멀티스레드·단순 캐시) 엔진 선택. DB 읽기 부하 감소·세션 스토어.\n▸ ALB(Application Load Balancer) — L7 HTTP/HTTPS 부하분산. URL 경로·호스트·헤더 기반 라우팅. WebSocket·HTTP/2 지원. 타겟: EC2·ECS·Lambda·IP.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n\n【정답 포인트】\n▸ (A) ALB: L7 HTTP/HTTPS 부하분산\n▸ (D) ElastiCache: 완전관리형 인메모리 캐시"
  },
  {
    "id": 391,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ AWS Snowball — 대용량 데이터를 물리 장치로 AWS에 오프라인 전송. Snowball Edge Storage Optimized(80TB), Compute Optimized(사전 처리용).\n▸ AWS Snow 패밀리 — Snowcone(8TB·소형), Snowball Edge, Snowmobile(100PB)로 오프라인 대용량 마이그레이션 및 엣지 컴퓨팅 지원.\n▸ AMI(Amazon Machine Image) — EC2 인스턴스 부팅에 필요한 OS·소프트웨어 구성 스냅샷. 커스텀 AMI로 동일 구성 빠르게 복제 가능.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 399,
  ...
  },
  {
    ...
    "answer": "DE",
    "explanation": "【핵심 용어】\n▸ EC2 Auto Scaling — 부하에 따라 EC2 인스턴스 수를 자동 조절. Target Tracking·Step·Scheduled·Predictive 정책. Min/Max/Desired 용량 설정.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ ALB(Application Load Balancer) — L7 HTTP/HTTPS 부하분산. URL 경로·호스트·헤더 기반 라우팅. WebSocket·HTTP/2 지원. 타겟: EC2·ECS·Lambda·IP.\n\n【정답 포인트】\n▸ (D) EC2 Auto Scaling: 부하에 따라 EC2 인스턴스 수를 자동 조절\n▸ (E) EC2 Auto Scaling: 부하에 따라 EC2 인스턴스 수를 자동 조절"
  },
  {
    "id": 406,
    ...
    "answer": "CD",
    "explanation": "【핵심 용어】\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n\n【정답 포인트】\n▸ (C) 퍼블릭 서브넷의 웹 서버에 대한 보안 그룹을 생성합니다. 포트 443 에서 0.0.0.0/0 의 트래픽을 허용하는 규칙을 추가\n▸ (D) DB 인스턴스에 대한 보안 그룹을 생성합니다. 포트 3306 에서 웹 서버 보안 그룹의 트래픽을 허용하는 규칙을 추가합니다."
  },
  {
    "id": 407,
  ...
  },
  {
    ...
    "answer": "BD",
    "explanation": "【핵심 용어】\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n▸ Amazon CloudFront — 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스. 정적·동적 콘텐츠 캐싱. DDoS 방어(Shield Standard 기본 포함). S3·ALB·EC2 오리진.\n\n【정답 포인트】\n▸ (B) CloudFront: 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스\n▸ (D) RDS: MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB"
  },
  {
    "id": 417,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon QuickSight — 완전관리형 서버리스 BI 도구. ML 인사이트·자연어 쿼리(Q). SPICE 인메모리 캐시. S3·Athena·RDS·Redshift 데이터 소스.\n▸ Amazon SageMaker — 완전관리형 ML 플랫폼. 데이터 준비·학습·튜닝·배포·모니터링 통합. 내장 알고리즘·커스텀 컨테이너·Studio IDE.\n\n【정답 포인트】\n▸ 핵심 서비스: QuickSight"
  },
  {
    "id": 433,
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ SCP(Service Control Policy) — AWS Organizations에서 OU·계정 레벨 최대 허용 권한 한도 설정. IAM 정책보다 우선. 거부 목록·허용 목록 방식.\n▸ AWS Organizations — 다중 AWS 계정 중앙 관리. OU(조직 단위) 계층 구조. SCP로 권한 통제. 통합 결제·볼륨 할인.\n\n【정답 포인트】\n▸ 정답은 SCP: 조직 수준 최대 허용 권한 한도 — IAM보다 우선 적용"
  },
  {
    "id": 434,
  ...
  },
  {
    ...
    "answer": "CE",
    "explanation": "【핵심 용어】\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n▸ Amazon VPC(Virtual Private Cloud) — AWS 내 논리적으로 격리된 가상 네트워크. 서브넷·라우팅 테이블·IGW·NAT·SG·NACL로 구성.\n▸ EC2 Auto Scaling — 부하에 따라 EC2 인스턴스 수를 자동 조절. Target Tracking·Step·Scheduled·Predictive 정책. Min/Max/Desired 용량 설정.\n▸ AWS Well-Architected Tool — 6대 기둥(운영 우수성·보안·안정성·성능 효율성·비용 최적화·지속 가능성) 기반 아키텍처 검토.\n\n【정답 포인트】\n▸ (C) VPC: AWS 내 논리적으로 격리된 가상 네트워크\n▸ (E) RDS: MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB"
  },
  {
    "id": 451,
  ...
  },
  {
    ...
    "answer": "BC",
    "explanation": "【핵심 용어】\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n▸ Amazon API Gateway — REST·HTTP·WebSocket API 생성·배포·관리. 인증(Cognito·Lambda Authorizer)·스로틀링·캐싱·스테이지 관리. Lambda·HTTP 엔드포인트 통합.\n\n【정답 포인트】\n▸ (B) Lambda: 서버리스 이벤트 기반 컴퓨팅\n▸ (C) RDS: MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB\n\n【오답 체크】\n(A) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화"
  },
  {
    "id": 459,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS CloudFormation — IaC(Infrastructure as Code) 서비스. YAML·JSON 템플릿으로 AWS 리소스 스택 선언적 프로비저닝·업데이트·삭제. 드리프트 탐지.\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n▸ ALB(Application Load Balancer) — L7 HTTP/HTTPS 부하분산. URL 경로·호스트·헤더 기반 라우팅. WebSocket·HTTP/2 지원. 타겟: EC2·ECS·Lambda·IP.\n▸ EC2 Auto Scaling — 부하에 따라 EC2 인스턴스 수를 자동 조절. Target Tracking·Step·Scheduled·Predictive 정책. Min/Max/Desired 용량 설정.\n\n【정답 포인트】\n▸ 정답은 CloudFormation: IaC 선언적 프로비저닝 — 반복 가능한 인프라 배포"
  },
  {
    "id": 480,
  ...
  },
  {
    ...
    "answer": "AE",
    "explanation": "【핵심 용어】\n▸ AWS IAM(Identity and Access Management) — AWS 리소스 접근 제어. 사용자·그룹·역할·정책으로 구성. 최소 권한 원칙. 자격증명: 액세스 키·MFA·패스워드.\n▸ AWS Organizations — 다중 AWS 계정 중앙 관리. OU(조직 단위) 계층 구조. SCP로 권한 통제. 통합 결제·볼륨 할인.\n▸ AWS IAM Identity Center(구 SSO) — 다중 계정·애플리케이션에 대한 중앙 집중 SSO. Active Directory·SAML IdP 연동. 최소 권한 접근 관리.\n\n【정답 포인트】\n▸ (A) Organizations: 다중 AWS 계정 중앙 관리\n▸ (E) IAM: AWS 리소스 접근 제어"
  },
  {
    "id": 485,
  ...
  },
  {
    ...
    "answer": "DE",
    "explanation": "【핵심 용어】\n▸ Amazon Comprehend — 자연어 처리(NLP) API. 감정 분석·개체 인식·주제 모델링·언어 감지.\n▸ Amazon Translate — 신경망 기계 번역. 75개 이상 언어 간 실시간·배치 번역.\n\n【정답 포인트】\n▸ (D) Amazon Transcribe를 사용하여 모든 언어의 오디오 녹음을 텍스트로 변환합니다.\n▸ (E) Comprehend: 자연어 처리(NLP) API"
  },
  {
    "id": 494,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon Macie — S3 버킷의 민감 데이터(PII·신용카드·자격증명) 자동 탐지·분류. ML 기반. GDPR·HIPAA 규정 준수 지원.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ AWS Lake Formation — S3 기반 데이터 레이크 구축·관리 자동화. 세분화된 테이블·컬럼 수준 접근 제어. Glue와 통합.\n\n【정답 포인트】\n▸ 정답은 Macie: S3 민감 데이터 자동 탐지·분류 — PII·규정 준수"
  },
  {
    "id": 496,
    ...
    "answer": "BD",
    "explanation": "【핵심 용어】\n▸ AWS Storage Gateway — 온프레미스와 AWS 클라우드 스토리지를 연결하는 하이브리드 서비스. File(S3 연동), Volume(iSCSI), Tape(Glacier 아카이브) 3가지 유형.\n\n【정답 포인트】\n▸ (B) Storage Gateway: 온프레미스와 AWS 클라우드 스토리지를 연결하는 하이브리드 서비스\n▸ (D) Storage Gateway: 온프레미스와 AWS 클라우드 스토리지를 연결하는 하이브리드 서비스\n\n【오답 체크】\n(C) Snowball은 오프라인 물리 전송 장치 — 인터넷 연결이 있으면 비효율적"
  },
  {
    "id": 497,
  ...
  },
  {
    ...
    "answer": "AD",
    "explanation": "【핵심 용어】\n▸ Amazon FSx for Windows File Server — SMB 프로토콜 기반 완전관리형 Windows 파일 시스템. Active Directory 통합. Windows 워크로드에 최적.\n▸ AWS DataSync — 온프레미스 NFS/SMB/HDFS 스토리지와 S3·EFS·FSx 간 데이터를 자동·고속 전송. 초기 마이그레이션·반복 동기화에 적합.\n\n【정답 포인트】\n▸ (A) FSx for Windows: SMB 프로토콜 기반 완전관리형 Windows 파일 시스템\n▸ (D) FSx for Windows: SMB 프로토콜 기반 완전관리형 Windows 파일 시스템\n\n【오답 체크】\n(E) Snowball은 오프라인 물리 전송 장치 — 인터넷 연결이 있으면 비효율적"
  },
  {
    "id": 501,
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon Kinesis Data Firehose — 스트리밍 데이터를 S3·Redshift·OpenSearch·HTTP 엔드포인트로 자동 적재. 완전관리형. 변환(Lambda)·압축·암호화 지원.\n▸ Amazon Kinesis Data Analytics — SQL 또는 Apache Flink로 스트리밍 데이터 실시간 분석. Kinesis Streams·Firehose와 통합.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n\n【정답 포인트】\n▸ 정답은 Kinesis Data Firehose: 스트리밍 데이터 S3/Redshift 자동 적재 — 관리 불필요"
  },
  {
    "id": 502,
  ...
  },
  {
    ...
    "answer": "BD",
    "explanation": "【핵심 용어】\n▸ AWS Backup — EC2·EBS·RDS·DynamoDB·EFS 등 여러 서비스 백업을 중앙 집중 관리. 자동화된 백업 정책과 규정 준수 보고서 제공.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ AMI(Amazon Machine Image) — EC2 인스턴스 부팅에 필요한 OS·소프트웨어 구성 스냅샷. 커스텀 AMI로 동일 구성 빠르게 복제 가능.\n\n【정답 포인트】\n▸ (B) EC2: 가상 서버 서비스\n▸ (D) AWS Backup: EC2·EBS·RDS·DynamoDB·EFS 등 여러 서비스 백업을 중앙 집중 관리"
  },
  {
    "id": 509,
  ...
  },
  {
    ...
    "answer": "BCE",
    "explanation": "【핵심 용어】\n▸ Amazon Redshift — 완전관리형 페타바이트급 클라우드 데이터 웨어하우스. 컬럼 기반 스토리지·MPP 아키텍처. OLAP 분석 쿼리에 최적화.\n\n【정답 포인트】\n▸ (B) 클라이언트 측 및 서버 측 암호화 지원\n▸ (C) 지정된 시간 동안 애플리케이션이 활성 상태가 아닐 때 분석 워크로드 구축\n▸ (E) 페타바이트 규모의 데이터와 분당 수천만 건의 요청을 지원하도록 전 세계적으로 확장 F. AWS Management Consol"
  },
  {
    "id": 516,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Service Catalog — 승인된 IT 서비스·CloudFormation 스택을 제품 포트폴리오로 관리. 셀프서비스 배포·거버넌스 일관성 유지.\n\n【정답 포인트】\n▸ 핵심 서비스: Service Catalog"
  },
  {
    "id": 520,
  ...
  },
  {
    ...
    "answer": "AD",
    "explanation": "【핵심 용어】\n▸ Amazon Route 53 — 완전관리형 DNS 서비스. 라우팅 정책: Simple·Weighted·Latency·Geolocation·Geoproximity·Failover·Multi-Value. 도메인 등록·Health Check 통합.\n▸ AWS ACM(Certificate Manager) — SSL/TLS 인증서 무료 발급·자동 갱신. ALB·CloudFront·API GW에 통합. EC2에는 직접 설치 불가(IAM 인증서 사용).\n▸ Amazon API Gateway — REST·HTTP·WebSocket API 생성·배포·관리. 인증(Cognito·Lambda Authorizer)·스로틀링·캐싱·스테이지 관리. Lambda·HTTP 엔드포인트 통합.\n\n【정답 포인트】\n▸ (A) Route 53: 완전관리형 DNS 서비스\n▸ (D) ACM: SSL/TLS 인증서 무료 발급·자동 갱신"
  },
  {
    "id": 533,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ S3 Glacier — 장기 아카이브 스토리지. Instant Retrieval(즉시), Flexible Retrieval(1–12h), Deep Archive(12–48h) 3단계. 비용 매우 저렴.\n▸ Amazon Lex — 음성·텍스트 기반 대화형 챗봇 구축. Alexa와 동일 기술. 인텐트·슬롯 정의로 대화 흐름 설계.\n▸ Amazon VPC(Virtual Private Cloud) — AWS 내 논리적으로 격리된 가상 네트워크. 서브넷·라우팅 테이블·IGW·NAT·SG·NACL로 구성.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 535,
  ...
  },
  {
    ...
    "answer": "ACE",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n▸ Amazon CloudFront — 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스. 정적·동적 콘텐츠 캐싱. DDoS 방어(Shield Standard 기본 포함). S3·ALB·EC2 오리진.\n\n【정답 포인트】\n▸ (A) Lambda: 서버리스 이벤트 기반 컴퓨팅\n▸ (C) Cognito: 웹·모바일 앱 사용자 인증·인가\n▸ (E) S3: 객체 스토리지 서비스"
  },
  {
    "id": 542,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon Redshift — 완전관리형 페타바이트급 클라우드 데이터 웨어하우스. 컬럼 기반 스토리지·MPP 아키텍처. OLAP 분석 쿼리에 최적화.\n▸ Amazon EMR — 완전관리형 Hadoop·Spark·Hive·Presto 클러스터. 빅데이터 ETL·ML·분석. EC2·EKS·Serverless 실행 모드.\n\n【정답 포인트】\n▸ 핵심 서비스: S3"
  },
  {
    "id": 558,
  ...
  },
  {
    ...
    "answer": "AB",
    "explanation": "【핵심 용어】\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n▸ Amazon EC2(Elastic Compute Cloud) — 가상 서버 서비스. 인스턴스 타입(범용·컴퓨팅·메모리·GPU 최적화), 구매 옵션(On-Demand·Reserved·Spot·Dedicated) 선택 가능.\n▸ Amazon VPC(Virtual Private Cloud) — AWS 내 논리적으로 격리된 가상 네트워크. 서브넷·라우팅 테이블·IGW·NAT·SG·NACL로 구성.\n\n【정답 포인트】\n▸ (A) 엔드포인트에 대한 라우팅 테이블 항목을 생성합니다.\n▸ (B) DynamoDB: 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB"
  },
  {
    "id": 563,
  ...
  },
  {
    ...
    "answer": "ACE",
    "explanation": "【핵심 용어】\n▸ Amazon ECS(Elastic Container Service) — AWS 완전관리형 컨테이너 오케스트레이션. Task Definition으로 컨테이너 구성. EC2 또는 Fargate 실행 모드.\n▸ AWS Outposts — AWS 인프라·서비스를 온프레미스 데이터센터에 설치. 낮은 지연·데이터 현지 처리 요구 사항에 대응. Local Zone과 구별.\n▸ Amazon RDS(Relational Database Service) — MySQL·PostgreSQL·MariaDB·Oracle·SQL Server·Aurora 완전관리형 관계형 DB. 자동 백업·패치·장애조치.\n\n【정답 포인트】\n▸ (A) Outposts: AWS 인프라·서비스를 온프레미스 데이터센터에 설치\n▸ (C) 데이터 센터 환경의 물리적 보안 및 액세스 제어.\n▸ (E) ECS: AWS 완전관리형 컨테이너 오케스트레이션"
  },
  {
    "id": 600,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon GuardDuty — ML 기반 위협 탐지. CloudTrail·VPC Flow Logs·DNS 로그 분석. 악의적 IP·비정상 API 호출·크립토마이닝 탐지. 에이전트 불필요.\n▸ AWS Security Hub — 다수 보안 서비스(GuardDuty·Inspector·Macie·Config)의 발견 사항을 중앙 집계·우선순위화·자동화.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ NLB(Network Load Balancer) — L4 TCP/UDP/TLS 부하분산. 초당 수백만 요청 처리, 고정 IP·EIP 지원. 극저지연. 게임·IoT·실시간 트래픽에 적합.\n\n【정답 포인트】\n▸ 정답은 GuardDuty: 에이전트 없는 ML 기반 위협 탐지 — CloudTrail·VPC Logs 분석"
  },
  {
    "id": 617,
    ...
    "answer": "BE",
    "explanation": "【핵심 용어】\n▸ Amazon EFS(Elastic File System) — NFS 기반 완전관리형 공유 파일 시스템. 다수의 EC2·Lambda·컨테이너가 동시에 마운트 가능. 멀티-AZ 고가용성.\n▸ AWS DataSync — 온프레미스 NFS/SMB/HDFS 스토리지와 S3·EFS·FSx 간 데이터를 자동·고속 전송. 초기 마이그레이션·반복 동기화에 적합.\n\n【정답 포인트】\n▸ (B) EFS: NFS 기반 완전관리형 공유 파일 시스템\n▸ (E) DataSync: 온프레미스 NFS/SMB/HDFS 스토리지와 S3·EFS·FSx 간 데이터를 자동·고속 전송"
  },
  {
    "id": 618,
  ...
  },
  {
    ...
    "answer": "AD",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n▸ Amazon CloudFront — 전 세계 400+ 엣지 로케이션을 통한 CDN 서비스. 정적·동적 콘텐츠 캐싱. DDoS 방어(Shield Standard 기본 포함). S3·ALB·EC2 오리진.\n\n【정답 포인트】\n▸ (A) DynamoDB: 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB\n▸ (D) S3: 객체 스토리지 서비스"
  },
  {
    "id": 623,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ Amazon QLDB(Quantum Ledger Database) — 변경 불가 암호화 검증 가능한 트랜잭션 원장 DB. 금융 거래·공급망 이력 추적.\n▸ Amazon Kinesis Data Streams — 실시간 데이터 스트리밍 수집. 샤드 단위 처리량(1MB/s 쓰기·2MB/s 읽기). 보관 기간 기본 24h(최대 365일). KCL로 소비.\n\n【정답 포인트】\n▸ 핵심 서비스: QLDB"
  },
  {
    "id": 632,
  ...
  },
  {
    ...
    "answer": "BC",
    "explanation": "【핵심 용어】\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ Amazon DynamoDB — 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB. 한 자릿수 밀리초 지연. 자동 스케일링. 최대 400KB 항목. 온디맨드·프로비저닝 용량 모드.\n\n【정답 포인트】\n▸ (B) Lambda: 서버리스 이벤트 기반 컴퓨팅\n▸ (C) DynamoDB: 완전관리형 서버리스 NoSQL 키-값/도큐먼트 DB\n\n【오답 체크】\n(D) EC2는 서버 관리 필요 — Lambda(서버리스)가 운영 오버헤드 최소화"
  },
  {
    "id": 638,
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "【핵심 용어】\n▸ AWS Lambda — 서버리스 이벤트 기반 컴퓨팅. 코드 실행 시간(최대 15분)·메모리 기준 과금. 이벤트 소스: S3·SQS·API GW·DynamoDB Streams 등. 자동 스케일링.\n▸ AWS Compute Optimizer — ML 기반으로 EC2·Lambda·EBS·ECS 리소스 과다/과소 프로비저닝 분석 및 최적 리소스 권고.\n\n【정답 포인트】\n▸ 정답은 Lambda: 서버리스 — 관리 불필요 + 이벤트 트리거 + 자동 스케일링"
  },
  {
    "id": 673,
    ...
    "answer": "BE",
    "explanation": "【핵심 용어】\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n▸ Amazon SageMaker — 완전관리형 ML 플랫폼. 데이터 준비·학습·튜닝·배포·모니터링 통합. 내장 알고리즘·커스텀 컨테이너·Studio IDE.\n▸ Amazon Forecast — 시계열 예측 서비스. 수요 예측·재고 계획·재무 예측에 활용.\n\n【정답 포인트】\n▸ (B) S3: 객체 스토리지 서비스\n▸ (E) S3: 객체 스토리지 서비스"
  },
  {
    "id": 674,
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "【핵심 용어】\n▸ AWS Migration Hub — 마이그레이션 진행 상황 중앙 추적. Server Migration Service·Database Migration Service 통합.\n▸ AWS Application Discovery Service — 온프레미스 서버 인벤토리·의존성 자동 수집. 마이그레이션 계획 수립에 활용.\n\n【정답 포인트】\n▸ 핵심 서비스: Migration Hub"
  },
  {
    "id": 678,
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "【핵심 용어】\n▸ AWS Glue — 완전관리형 서버리스 ETL 서비스. 데이터 카탈로그(메타데이터 저장소)·크롤러(스키마 자동 감지)·ETL 작업(Spark 기반) 통합.\n▸ AWS Glue DataBrew — 코드 없는 시각적 데이터 준비 도구. 250개 이상 변환. 데이터 품질·프로파일링.\n▸ Amazon S3(Simple Storage Service) — 객체 스토리지 서비스. 무제한 용량, 99.999999999% 내구성. 버킷 단위로 관리하며 정적 웹사이트 호스팅, 데이터 레이크 등에 활용.\n\n【정답 포인트】\n▸ 정답은 Glue: 서버리스 ETL + 데이터 카탈로그 + 크롤러 자동 스키마 감지"
  },
  {
    "id": 689,
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "【핵심 용어】\n▸ Amazon VPC(Virtual Private Cloud) — AWS 내 논리적으로 격리된 가상 네트워크. 서브넷·라우팅 테이블·IGW·NAT·SG·NACL로 구성.\n▸ Amazon MSK(Managed Streaming for Kafka) — 완전관리형 Apache Kafka. 브로커·ZooKeeper 관리 자동화. 기존 Kafka 애플리케이션 그대로 이전 가능.\n▸ AMI(Amazon Machine Image) — EC2 인스턴스 부팅에 필요한 OS·소프트웨어 구성 스냅샷. 커스텀 AMI로 동일 구성 빠르게 복제 가능.\n\n【정답 포인트】\n▸ 핵심 서비스: VPC"
  },
  {
    "id": 699,
